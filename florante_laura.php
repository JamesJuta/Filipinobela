...
<head>
    ...
    <!-- CSS Style Sheets -->
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="./css/florante_laura_styles.css">
...
<body>
			...
			<header>
				<div class="image-text">
					...
					<div class="text logo-text">
						<span class="name_two">Florante at Laura </span>
					</div>
				</div>
		    ...
		    <ul class="menu-links tabs">
                ...
                <li data-tab-target="#kaalaman" class="tab nav-link">
                    <a href="#">
                        ...
                        <span class="text nav-text">Ano ang Awit?</span>
                    </a>
                </li>
    ...
    <section class="home ">
        ...
        <div class="tab-content">
                    ...
                    <!-- Florate at Laura page -->
                    <?php include 'florante_laura/talambuhay.php'; ?>

                    <?php include 'florante_laura/kaalaman.php'; ?>

                    <?php include 'florante_laura/nobela.php'; ?>

                    <?php include 'florante_laura/korido_1.php'; ?>

                    <?php include 'florante_laura/korido_2.php'; ?>

                    <?php include 'florante_laura/korido_3.php'; ?>

                    <?php include 'florante_laura/korido_4.php'; ?>

                    <?php include 'florante_laura/korido_5.php'; ?>

                    <?php include 'florante_laura/korido_6.php'; ?>
                    
                    <?php include 'florante_laura/korido_7.php'; ?>

                    <?php include 'florante_laura/korido_8.php'; ?>

                    <?php include 'florante_laura/korido_9.php'; ?>

                    <?php include 'florante_laura/korido_10.php'; ?>

                    <?php include 'florante_laura/korido_11.php'; ?>

                    <?php include 'florante_laura/korido_12.php'; ?>

                    <?php include 'florante_laura/korido_13.php'; ?>

                    <?php include 'florante_laura/korido_14.php'; ?>

                    <?php include 'florante_laura/korido_15.php'; ?>

                    <?php include 'florante_laura/korido_16.php'; ?>
                    
                    <?php include 'florante_laura/korido_17.php'; ?>

                    <?php include 'florante_laura/korido_18.php'; ?>

                    <?php include 'florante_laura/korido_19.php'; ?>

                    <?php include 'florante_laura/korido_20.php'; ?>

                    <?php include 'florante_laura/korido_21.php'; ?>

                    <?php include 'florante_laura/korido_22.php'; ?>

                    <?php include 'florante_laura/korido_23.php'; ?>

                    <?php include 'florante_laura/korido_24.php'; ?>

                    <?php include 'florante_laura/korido_25.php'; ?>

                    <?php include 'florante_laura/korido_26.php'; ?>
                    
                    <?php include 'florante_laura/korido_27.php'; ?>

                    <?php include 'florante_laura/korido_28.php'; ?>

                    <?php include 'florante_laura/korido_29.php'; ?>

                    <?php include 'florante_laura/buod.php'; ?>
