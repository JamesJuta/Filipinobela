...
<head>
    ...
    <title>Kabanata 28 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 28 - El Filibusterismo</u></center></h1>
        </div>
        ...
        <div id="question" class="quiz_form" ></div>
            <form id="quiz-form" >
                ...
                <div id="options" class="quiz_form"></div>
     ...
     <script>
        const questions = [
            {
                question: "Naisip ni Quiroga na sumangguni kay ___ kung panahon na gamitin ang mga baril, pulbura at bala na ipinatago nito sa kanya.",
                options: ["Ibarra", "Isagani", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "May dalawang ___ na nakapatong sa mga papeles ng manunulat.",
                options: ["Pistol", "Rebolber", "Sandata"],
                answer: "Rebolber"
            },
            {
                question: "MMay naghalughog sa bahay ni ___ kung saan si Basilio ay nanunuluyan.",
                options: ["Don Custodio", "Kapitan Tiyago", "Padre Salvi"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "May ___ tao na nahuling nagbabaon ng sandata sa silong ng isang bahay na tabla.",
                options: ["Dalawang", "Isang", "Tatlong"],
                answer: "Dalawang"
            },
            {
                question: "Pinalitan ang mga tanod sa pinto ng siyudad nang gabing iyon. Mga artilyerong ___ ang ipinalit.",
                options: ["Espanyol", "Intsik", "Kastila"],
                answer: "Kastila"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_28.php"; // Replace with the actual href link
