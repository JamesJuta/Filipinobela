...
<head>
    ...
    <title>Kabanata 10 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 10 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang kinuha ni Kabesang Tales sa gamit ni Simoun?",
                options: ["Bomba", "Itak", "Rebolber"],
                answer: "Rebolber"
            },
            {
                question: "Si Hermana Penchang ay namimili ng alahas na ilalagay sa Birhen ng?",
                options: ["Antipolo", "Maynila", "San Diego"],
                answer: "Antipolo"
            },
            {
                question: "Sino ang natanawan ni Kabesang Tales sa kanyang dating lupa?",
                options: ["Ang kinatawan ng Pamahalaan", "Ang mga Kastila", "Ang mga Prayle"],
                answer: "Ang mga Prayle"
            },
            {
                question: "Sino ang napatay ni Kabesang Tales gamit ang rebolber?",
                options: ["Ang isang Kastila at lalaking gumagawa ng lupa", "Ang magaalahas at ang ang prayle", "Ang prayle, ang lalaking gumagawa ng lupa at ang asawa nito"],
                answer: "Ang prayle, ang lalaking gumagawa ng lupa at ang asawa nito"
            },
            {
                question: "Ano ang nakita sa bangkay ng babae?",
                options: ["Dahon na may nakasulat na 'Prayle'", "Kahoy na may nakasulat na 'Katarungan'", "Papel na may nakasukat na 'Tales'"],
                answer: "Papel na may nakasukat na 'Tales'"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_10.php"; // Replace with the actual href link
