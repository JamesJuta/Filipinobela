...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 37 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Siya ang payat na platerong na nagdala ng hikaw kay Paulita?",
                options: ["Chikoy", "Isagani", "Tadeo"],
                answer: "Chikoy"
            },
            {
                question: "Sino ang kasintahan ni Momoy?",
                options: ["Chikoy", "Paulita", "Siensa"],
                answer: "Siensa"
            },
            {
                question: "Biglang natakot si Momoy ngunit nang makita ang kasintahan na si Siensa na nakatingin sa kanya ay ___ ito.",
                options: ["Nagiyak-iyakan", "Naglungkot-lungkutan", "Nagtapang-tapangan"],
                answer: "Nagtapang-tapangan"
            },
            {
                question: "Ano ang ibig sabihin ng buktot?",
                options: ["Nakakabigla", "Nakakapagod", "Nakakatakot"],
                answer: "Nakakatakot"
            },
            {
                question: "Ano ang kahulugan ng Platero?",
                options: ["Gumagawa ng alahas", "Gumagawa ng pigura", "Gumagawa ng plato"],
                answer: "Gumagawa ng alahas"
            }
        ];
