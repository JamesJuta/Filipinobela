...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 18 - El Filibusterismo</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang Amerikanong magaling magsalita sa wikang Kastila?",
                options: ["Mr. Leeds", "Padre Camorra", "Padre Sibyla"],
                answer: "Mr. Leeds"
            },
            {
                question: "Ano ang bagay na hinahanap ni Ben Zayb para sa pandaraya?",
                options: ["Panyo", "Payong", "Salamin"],
                answer: "Salamin"
            },
            {
                question: "Ano ang pangalan ng paraon ng ehipto?",
                options: ["Imuthis", "Khufu", "Wangu"],
                answer: "Khufu"
            },
            {
                question: "Sino ang namamahala sa pagnanakaw ng kapangyarihan at pandaraya?",
                options: ["Gautama", "Sumerdis", "Wangu"],
                answer: "Gautama"
            },
            {
                question: "Sino ang umibig sa anak ng pari at naging kaagaw rito?",
                options: ["Gautama", "Imuthis", "Khufu"],
                answer: "Imuthis"
            }
        ];
