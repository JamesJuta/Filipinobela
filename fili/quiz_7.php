...
<head>
    ...
    <title>Kabanata 7 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 7 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang nanutok ng baril kay Basilio sa kagubatan?",
                options: ["Elias", "Isagani", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "Sino ang dapat magtulungan at parehas uhaw sa katarungan?",
                options: ["Isagani at Basilio", "Isagani at Simoun", "Simoun at Basilio"],
                answer: "Simoun at Basilio"
            },
            {
                question: "Ano ang nais isakatuparan ni Basilio na labis namang tinutulan ni Simoun?",
                options: ["Ang pagtuturo ng wikang Ingles", "Ang pagtuturo ng wikang Kastila", "Ang pagtuturo ng wikang Tagalog"],
                answer: "Ang pagtuturo ng wikang Kastila"
            },
            {
                question: "Ano ang piniling kurso ni Basilio na makatutulong sa paggamot sa Pilipinas?",
                options: ["Matematika", "Siyensiya", "Teknoloholiya"],
                answer: "Siyensiya"
            },
            {
                question: "Ano ang matinding balak ng dalawa na nais nila maisakatuparan?",
                options: ["Pagbabalat-kayo", "Paghihiganti", "Pagsanib sa Kastila"],
                answer: "Paghihiganti"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_7.php"; // Replace with the actual href link
