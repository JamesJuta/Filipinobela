...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 11 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang ginamit ng Kapitan Heneral sa pangangaso?",
                options: ["Baril", "Itak", "Musiko"],
                answer: "Musiko"
            },
            {
                question: "Dito naglaro ng baraha sina Padre Irene, Padre Sibyla, Padre Camorra at ang Kapaitan?",
                options: ["Bahay-Aliwan", "Bahay-Komedya", "Bahay-Paanakan"],
                answer: "Bahay-Aliwan"
            },
            {
                question: "Sino ang pinalitan ni Simoun na naiinis dahil lagi syang talo?",
                options: ["Padre Camora", "Padre Irene", "Padre Sibyla"],
                answer: "Padre Camora"
            },
            {
                question: "Ano ang napag-usapan ng mga Heneral na kanyang ipinagbabawal?",
                options: ["Armas de Salon", "Paaralang Kastila", "Paggala sa Gabi"],
                answer: "Armas de Salon"
            },
            {
                question: "Sino ang hindi dapat mag-aral sa Akademya?",
                options: ["Dominikano", "Indio", "Kastila"],
                answer: "Indio"
            }
        ];
