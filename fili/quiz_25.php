...
<head>
    ...
    <title>Kabanata 25 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 25 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saang lugar idinaos ng mga mag-aaral ang piging?",
                options: ["Panciteria Macanista de Buen Gusto", "Panciteris Macanista de Buen Gusto", "Panciteris Macanists de Buen Gusto"],
                answer: "Panciteria Macanista de Buen Gusto"
            },
            {
                question: "Sino ang nais ni Tadeo na imbitahan sa kainan?",
                options: ["Kapitan Heneral", "Padre Salvi", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "Ano ang inihandog na pagkain kay Don Custodio?",
                options: ["Adobong manok at itlog", "Palabok at chicharon", "Pansit lang-lang at sopas"],
                answer: "Pansit lang-lang at sopas"
            },
            {
                question: "Sino ang hindi handa sa pagtatalumpati?",
                options: ["Pecson", "Simoun", "Tadeo"],
                answer: "Tadeo"
            },
            {
                question: "Sino ang inatake ng mga pari dahil sa pagtatalumpati nito?",
                options: ["Don Custodio", "Isagani", "Pecson"],
                answer: "Pecson"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_25.php"; // Replace with the actual href link
