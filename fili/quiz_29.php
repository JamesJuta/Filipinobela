...
<head>
    ...
    <title>Kabanata 29 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 29 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Marangya ang libing ni ___. Hinirang si Padre Irene na tagapamahala at tagapagpatupad ng testamento ng kapitan.",
                options: ["Kapitan Heneral", "Kapitan Tiyago", "Kapitana Maria"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Inalis ni Kapitan Tiyago ang ___ na pamana kay Basilio.",
                options: ["dalawampu’t dalawang piso", "dalawampu’t limang piso", "dalawanpung piso"],
                answer: "dalawampu’t limang piso"
            },
            {
                question: "Ang ___ ay tumutol at sinabing dapat prak ang ipasuot sa mga pagtitipon.",
                options: ["Modista", "Sastre", "Taga-ayos"],
                answer: "Sastre"
            },
            {
                question: "Ano ang halaga ng niyari niyang damit?",
                options: ["Apatnapu’t dalawang piso", "Dalawangpu’t dalawang piso", "Tatlumpu’t dalawang piso"],
                answer: "Tatlumpu’t dalawang piso"
            },
            {
                question: "Sino ang kalaban ng Kapitan?",
                options: ["Donya Patrocinio", "Donya Victorina", "Hermana Penchang"],
                answer: "Donya Patrocinio"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_29.php"; // Replace with the actual href link
