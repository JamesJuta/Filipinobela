...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 13 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Anong asignatura ang itinuturo sa rektangular na bulwagang silid?",
                options: ["Artes", "Pilisopiya", "Pisika"],
                answer: "Pisika"
            },
            {
                question: "Sino ang Dominikanong pari na naging guro sa klase ng Pisika?",
                options: ["Padre Damaso", "Padre Millon", "Padre Sibyla"],
                answer: "Padre Millon"
            },
            {
                question: "Kanino nabaling ang galit ng propesor?",
                options: ["Basilio", "Juanito", "Placido"],
                answer: "Placido"
            },
            {
                question: "Ano ang hudyat na tapos na ang klase?",
                options: ["Sigaw na tapos na ang klase", "Tugtog ng kampanilya", "Tugtog ng musiko"],
                answer: "Tugtog ng kampanilya"
            },
            {
                question: "Ano ang tinawag ng propesor dahil sa pagkuha nito ng atensyon?",
                options: ["Placidong Magulo", "Placidong Maingay", "Placidong Tagadikta"],
                answer: "Placidong Tagadikta"
            }
        ];
