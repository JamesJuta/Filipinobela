...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 22 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang hinihintay upang umpisahan ang dulaan?",
                options: ["Don Primitivo", "Kapitan Heneral", "Simoun"],
                answer: "Napayuko"
            },
            {
                question: "Ilan ang dahilan ni Kapitan Heneral kung bakit siya manonood ng palabas?",
                options: ["Apat", "Dalawa", "Isa"],
                answer: "Dalawa"
            },
            {
                question: "Sino ang nakita ni Isagani sa dulaan na kasama ni Paulita?",
                options: ["Pecson", "Pelaez", "Pepay"],
                answer: "Pelaez"
            },
            {
                question: "Sino ang pinag-espiya ni Padre Salvi sa panonood ng dula?",
                options: ["Padre Irene", "Serpolette", "Tadeo"],
                answer: "Padre Irene"
            },
            {
                question: "Ano ang dahilan ni Padre Salvi kung bakit pinag-espiya si Padre Irene sa mga Pranses?",
                options: ["Dahil malaman ang mga kaganapan sa loob ng dulaan", "Dahil masama ang mga palabas nito", "Dahil may nagbebenta ng mga pinagbabawal na gamot"],
                answer: "Dahil masama ang mga palabas nito"
            }
        ];
