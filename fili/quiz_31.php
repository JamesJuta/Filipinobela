...
<head>
    ...
    <title>Kabanata 31 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 31 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang hindi nabalita sa pahayagan?",
                options: ["Ang pagkamatay ni Juli", "Ang pagkamatay ni Kapitan Tiyago", "Ang pagkamatay ni Maria Clara"],
                answer: "Ang pagkamatay ni Juli"
            },
            {
                question: "Sino lamang ang nakalaya sa kulungan?",
                options: ["Basilio at Isagani", "Makaraig at Basilio", "Makaraig at Isagani"],
                answer: "Makaraig at Isagani"
            },
            {
                question: "Sino ang nagtatanggol kay Basilio?",
                options: ["Kapitan Heneral", "Mataas na Kawani", "Padre Camorra"],
                answer: "Mataas na Kawani"
            },
            {
                question: "Ano ang binibintang ng Heneral kay Basilio?",
                options: ["Ang paggamit ng bawal na aklat sa medisina", "Ang paggamit ng bawal na gamot", "Ang paggamit ng rebolber"],
                answer: "Ang paggamit ng bawal na aklat sa medisina"
            },
            {
                question: "Ilang oras bago magbitiw sa tungkulin ang Heneral?",
                options: ["Dalawang oras", "Limang oras", "Pitong oras"],
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_31.php"; // Replace with the actual href link
