...
<head>
    ...
    <title>Kabanata 17 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 17 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ilan ang nagtungo sa perya mula sa bahay ni Quiroga?",
                options: ["Labindalawa", "Labing-isa", "Sampu"],
                answer: "Labindalawa"
            },
            {
                question: "Sino ang nahumaling sa ganda ni Paulita Gomez?",
                options: ["Mr. Leeds", "Padre Camora", "Padre Sibyla"],
                answer: "Padre Camora"
            },
            {
                question: "Ano ang makikita sa tindahan na kanilang pinasukan?",
                options: ["Estatwang bakal", "Estatwang ginto", "Estatwang kahoy"],
                answer: "Estatwang kahoy"
            },
            {
                question: "Kaninong estatwa ang pinaghalong puti at itim?",
                options: ["Elias", "Isagani", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "Sino ang nagwika na natuklasan ni Simoun and lihim ng kaibigan nitong si Mr. Leeds?",
                options: ["Ben Zayb", "Pelaez", "Quiroga"],
                answer: "Ben Zayb"
            }
        ];
