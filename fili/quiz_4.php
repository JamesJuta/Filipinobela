...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 4 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang umampon kay Basilio sa kagubatan?",
                options: ["Kabesang Tales", "Tandang Selo", "Tandang Sora"],
                answer: "Tandang Selo"
            },
            {
                question: "Sino ang asawa ni kabesang tales na namatay sa malaria?",
                options: ["Juli", "Lucia", "Tano"],
                answer: "Lucia"
            },
            {
                question: "Ang nang-akin sa lupa na binili ni Kabesang tales na lalo pang tinaasan ang buwis.",
                options: ["Juli", "Lucia", "Tano"],
                answer: "Tano"
            },
            {
                question: "Sino ang bumili sa lupa ni Kabesang tales?",
                options: ["Mga Indio", "Mga Kastila", "Mga Prayle"],
                answer: "Mga Prayle"
            },
            {
                question: "Ang halaga ng pagkatubos ni Kabesang Tales sa mga anak.",
                options: ["400", "500", "700"],
                answer: "500"
            }
        ];
