...
<head>
    ...
    <title>Kabanata 19 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 19 - El Filibusterismo</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang inang ni Placido na taga- Batangas?",
                options: ["Kabesang Andang", "Kabesang Tales", "Tandang Selo"],
                answer: "Kabesang Andang"
            },
            {
                question: "SSaan nais pumunta ni Placido upang kalabanin ang mga pari?",
                options: ["Amerika", "Hongkong", "Madrid"],
                answer: "Hongkong"
            },
            {
                question: "Ilang oras nag-usap sa bahay ni Simoun at ang binata bago umuwi sa kaserahan ni Placido?",
                options: ["Dalawang oras", "Isang oras", "Tatlong oras"],
                answer: "Dalawang oras"
            },
            {
                question: "Sino ang nakita ni Placido na lulan ng kanilang sasakyan?",
                options: ["Padre Camorra at Don Heneral", "Padre Salvi at Don Juan", "Padre Sibyla at Don Custodio"],
                answer: "Padre Sibyla at Don Custodio"
            },
            {
                question: "Saan nakarating ang dalawa na kanilang nakilala ang may ari sa San Diego?",
                options: ["Bahay na pagawaan ng pulbura", "Bahay-paaralan", "Malawak na gubat"],
                answer: "Bahay na pagawaan ng pulbura"
            }
        ];
