...
<head>
    ...
    <title>Kabanata 30 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 30 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "AAno ang balita na nalaman sa buong bayan ng San Diego?",
                options: ["Ang pagkamatay ni Kapitan Tiyago at Maria Clara.", "Ang pagkamatay ni Kapitan Tiyago at pagkakadakip kay Basilio.", "Ang pagkamatay ni Maria Clara at pagkakadakip kay Basilio."],
                answer: "Ang pagkamatay ni Kapitan Tiyago at pagkakadakip kay Basilio."
            },
            {
                question: "Sino ang labis na nagdamdam?",
                options: ["Donya Victorina", "Juli", "Paulita"],
                answer: "Juli"
            },
            {
                question: "Kanino humingi ng tulong si Juli upang ilabas sa kulungan si Basilio?",
                options: ["Padre Camorra", "Padre Fernandez", "Padre Salvi"],
                answer: "Padre Camorra"
            },
            {
                question: "Sino ang pumilit kay Juli na humingi ng tulong sa Padre upang ilabas sa kulungan si Basilio?",
                options: ["Donya Victorina", "Hermana Bali", "Hermana Penchang"],
                answer: "Hermana Bali"
            },
            {
                question: "Sino ang matandang nagsisigaw at nagwala sa harap ng bulwagan?",
                options: ["Padre Florentino", "Quiroga", "Tandang Selo"],
                answer: "Tandang Selo"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_30.php"; // Replace with the actual href link
