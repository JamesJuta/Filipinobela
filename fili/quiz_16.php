...
<head>
    ...
    <title>Kabanata 16 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 16 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang negosyanteng Intsik na naghahangad magkaroon ng konsulado?",
                options: ["Basilio", "Isagani", "Quiroga"],
                answer: "Quiroga"
            },
            {
                question: "Ano ang halaga ng utang ni Quiroga kay Simoun na magaalahas?",
                options: ["Pitong libong piso", "Siyam na libong piso", "Walong libong piso"],
                answer: "Siyam na libong piso"
            },
            {
                question: "Magkano ang halaga ng ibinigay ni Simoun kay Quiroga?",
                options: ["Dalawang libong piso", "Isang libong piso", "Tatlong libong piso"],
                answer: "Dalawang libong piso"
            },
            {
                question: "Sumang-ayon ba si Quiroga sa pagtatago ng kagamitan ni Simoun sa kanyang bodega?",
                options: ["Hindi", "Oo", "Wala siyang kibo"],
                answer: "Oo"
            },
            {
                question: "Sino ang namamahala sa perya ng Quiapo na may ulong nagsasalita?",
                options: ["Mr. Armstrong", "Mr. John", "Mr. Leeds"],
                answer: "Mr. Leeds"
            }
        ];
