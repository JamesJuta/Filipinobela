...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 24 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saang lugar nag-uusap sina Isagani at Paulita?",
                options: ["Bahay ni Paulita", "Luneta", "Simbahan"],
                answer: "Luneta"
            },
            {
                question: "Siya ang may pagtatangi kay Pelaez?",
                options: ["Donya Victorina", "Juli", "Pepay"],
                answer: "Donya Victorina"
            },
            {
                question: "Saan gustong manirahan si Isagani?",
                options: ["Gubat", "Lungsod", "Nayon"],
                answer: "Nayon"
            },
            {
                question: "Sino ang pinatanungan ni Donya Victorina kung nasaan ang kanyang asawa?",
                options: ["Isagani", "Paulita", "Pelaez"],
                answer: "Paulita"
            },
            {
                question: "Sino ang kabiyak ni Isagani?",
                options: ["Juli", "Maria Clara", "Paulita"],
                answer: "Paulita"
            }
        ];
