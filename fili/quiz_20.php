...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 20 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Nasa kamay ni __ ang usapin sa akademya ng wikang Kastila at hinayaan na siya ang lumutas ng suliranin na ito.",
                options: ["Don Custodio", "Don Juan", "Kapitan Heneral"],
                answer: "Don Custodio"
            },
            {
                question: "Ano ang tanyag na pangalan ni Don Custodio de Salazar y Sanchez de Monteredondo?",
                options: ["Buena Mayor", "Buena Sanchez", "Buena Tinta"],
                answer: "Buena Tinta"
            },
            {
                question: "Ano ang katangian mayroon si Don Custodio?",
                options: ["Mabait", "Masipag", "May malasakit"],
                answer: "Masipag"
            },
            {
                question: "Saang lugar binibigyang halaga ang pag-aaral?",
                options: ["Amerika", "Espanya", "Hongkong"],
                answer: "Espanya"
            },
            {
                question: "Ilang taon namalagi sa Espanya si Don Custodio?",
                options: ["Dalawang taon", "Isang taon", "Tatlong taon"],
                answer: "Isang taon"
            }
        ];
