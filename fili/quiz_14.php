...
<head>
    ...
    <title>Kabanata 14 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 14 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ang pinuno ng kilusan para sa Akademya ng wikang Kastila at kumukuha ng kursong Abogasya.",
                options: ["Makaraig", "Makata", "Maliksi"],
                answer: "Makaraig"
            },
            {
                question: "Sino ang naging larawan ng mga kastilang may malasakit at pagpapahalaga sa mga Pilipino.",
                options: ["Isagani", "Pecson", "Sandoval"],
                answer: "Sandoval"
            },
            {
                question: "Sino naniniwala na maaaprubahan ang pagbukas ng paaralang kastila?",
                options: ["Isagani", "Pecson", "Pelaez"],
                answer: "Isagani"
            },
            {
                question: "Sino ang nag-aalinlangan na maaprubahan ang paaralang kastila?",
                options: ["Isagani", "Pecson", "Pelaez"],
                answer: "Pecson"
            },
            {
                question: "Sino ang kataas-taasang lipon ng paaralan na pumanig sa pagpapatayo ng paaralan?",
                options: ["Don Custodio", "Don Ibarra", "Don Juan"],
                answer: "Don Custodio"
            }
        ];
