...
<head>
    ...
    <title>Kabanata 39 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 39 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Si Simoun naman ay ayaw magpagamot sa ospital ngunit pumayag na mag-paalaga kay ___.",
                options: ["Basilio", "Dr. De Espadaña", "Isagani"],
                answer: "Dr. De Espadaña"
            },
            {
                question: "Anang telegram, “Espanyol escondido casa Padre Florentino cojera remitara vivo muerte”. Si ___ talaga ang tinutukoy sa telegrama.",
                options: ["Kabesang Tales", "Kapitan Heneral", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "___ din ni Isagani ang pagkakadali ng kasal ni Paulita at Juanito sa tulong ni Simoun.",
                options: ["Ikinagalit", "Ikinalungkot", "Ikinasaya"],
                answer: "Ikinalungkot"
            },
            {
                question: "Isinalaysay ni Simoun ang kanyang buhay. ___ taon siyang tumigil sa Europa upang mag-aral saka bumalik sa Pilipinas na puno ng pangarap at pag-asa.",
                options: ["Labindalawang taon", "Labinpitong taon", "Labintatlong taon"],
                answer: "Labintatlong taon"
            },
            {
                question: "Inihagis ni Padre Florentino ang mga kagamitan  na ___ at ___ ni Simoun sa dagat.",
                options: ["Armas at ginto", "Baril at alahas", "Brilyante at alahas"],
                answer: "Brilyante at alahas"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_39.php"; // Replace with the actual href link
