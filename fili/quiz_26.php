...
<head>
    ...
    <title>Kabanata 26 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 26 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Dadalawin ni Basilio ang pasyente sa ospital ng ___.",
                options: ["Hospicio de San JoseSan Juan de Dios", "San Juan de Dios", "San Juana Dios"],
                answer: "San Juana Dios"
            },
            {
                question: "Nang malamang kasapi si Basilio sa kapisanan pinayuhan nito ang binata na umuwi at sirain ang lahat ng ___.",
                options: ["Ebidensyang", "Gamit", "Kasulatang"],
                answer: "Kasulatang"
            },
            {
                question: "Napag-alaman ni Basilio na marami raw mga estudyanteng ___, ___, at ___ sa pag-aaral.",
                options: ["papupugutan ng ulo, ipabibilanggo, at ibabagsak", "papupugutan ng ulo, ipapatapon, at ibabagsak", "tatanggalin, ipabibilanggo, at ibabagsak"],
                answer: "papupugutan ng ulo, ipabibilanggo, at ibabagsak"
            },
            {
                question: "Si Juanito ay parang ___ na paulit-ulit na sinasabing wala siyang kinalaman.",
                options: ["Baliw", "Nakadroga", "Wala sa sarili"],
                answer: "Wala sa sarili"
            },
            {
                question: "Sinabi ni Makaraig na ___ siya ni Basilio.",
                options: ["Maaasahan", "Makakatulong", "Masipag"],
                answer: "Maaasahan"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_26.php"; // Replace with the actual href link
