...
<head>
    ...
    <title>Kabanata 23 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 23 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Bakit hindi pumunta si Basilio sa teatro?",
                options: ["Dahil may kaaway siyang dadalo sa panonood", "Dahil siya ay pupuntang San Diego", "Dahil tinatamad lang ito"],
                answer: "Dahil siya ay pupuntang San Diego"
            },
            {
                question: "Sino ang ginamot ni Basilio sa San Diego?",
                options: ["Camarroncocido", "Kapitan Heneral", "Kapitan Tiyago"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Sino ang muling naghimok kay Basilio upang makiisa sa himagsikan?",
                options: ["Juli", "Kapitan Heneral", "Simoun"],
                answer: "Simoun"
            },
            {
                question: "Ano ang hinihithit ni Kapitan Tiyago sa pagkawala niya sa sarili?",
                options: ["Langis", "Opyo", "Ragbi"],
                answer: "Opyo"
            },
            {
                question: "Paano nalaman ni Kapitan Tiyago na namayapa na ang kanyang anak na si Maria Clara?",
                options: ["Ibinalita ito ni Basilio", "Kumalat ito sa baryo nila", "Pinadalahan ni Padre Salvi kay Padre Irene ang liham"],
                answer: "Pinadalahan ni Padre Salvi kay Padre Irene ang liham"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_23.php"; // Replace with the actual href link
