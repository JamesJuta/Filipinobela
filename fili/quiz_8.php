...
<head>
    ...
    <title>Kabanata 8 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 8 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang nagtungo sa kinalalagyan ng Mahal na Birhen upang tingnan kung naghimala ito?",
                options: ["Juli", "Lucia", "Tano"],
                answer: "Juli"
            },
            {
                question: "Saan patutungo si Juli sa araw ng Pasko?",
                options: ["Hermana Penchang", "Kapitan Tiyago", "Tandang Selo"],
                answer: "Hermana Penchang"
            },
            {
                question: "Ano ang kadalasang ginagawa ng mga bata noon na ginagawa pa rin sa kasalukuyan?",
                options: ["Pagsisimba", "Pagsisimba at Pamamasko", "Pamamasko"],
                answer: "Pagsisimba at Pamamasko"
            },
            {
                question: "Sino ang hindi makapagsalita?",
                options: ["Hermana Penchang", "Kapitan Tiyago", "Tandang Selo"],
                answer: "Tandang Selo"
            },
            {
                question: "Ang halaga na binibigay sa Mahal na Birhen upang makapaghimala.",
                options: ["Dalawandaan at limampung piso", "Isandaan at limampung pjso", "Tatlondaan at limampung piso"],
                answer: "Dalawandaan at limampung piso"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_8.php"; // Replace with the actual href link
