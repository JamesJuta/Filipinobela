...
<head>
    ...
    <title>Kabanata 33 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 33 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Maaga pa ay inayos na ni Simoun ang kanyang mga ___ at ___.",
                options: ["hiyas at armas", "pagkain at armas", "palakol at papel"],
                answer: "hiyas at armas"
            },
            {
                question: "Kinahapunan ay nagkulong si Simoun sa kanyang silid at nagbilin na wala siyang ibang tatanggapin kundi si ___ lamang.",
                options: ["Basilio", "Isagani", "Juanito"],
                answer: "Basilio"
            },
            {
                question: "Sa kanyang pag-iwas kay Simoun at sa mga plano nito ay wala umano siyang napala kundi ang ___.",
                options: ["Pagkabalisa", "Pagkainisin", "Pagkakulong"],
                answer: "Pagkakulong"
            },
            {
                question: "Nagpunta sila sa laboratoryo at ipinakita ni Simoun ang isang ___ kay Basilio.",
                options: ["Granada", "Palakol", "Rebolber"],
                answer: "Granada"
            },
            {
                question: "Sinabihan ni Simoun si Basilio na sa ___ ng gabi ay magkikita sila sa tapat ng simbahan ng San Sebastian para sa mga huling tagubilin.",
                options: ["Ikapito", "Ikasampu", "Ikasiyam"],
                answer: "Ikasampu"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_33.php"; // Replace with the actual href link
