...
<head>
    ...
    <link rel="shortcut icon" type="images/png" href="../images/EL.png">
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Buod - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ang tawag sa bapor na daanan ng manlalakbay sa pagitan ng Maynila at Laguna.",
                options: ["Bapor Vesta", "Bapor Bay", "Bapor Tabo"],
                answer: "Bapor Tabo"
            },
            {
                question: "Ang naging hanapbuhay ni Simoun makalipas ang labintatlong taon.",
                options: ["Guwardiya Sibil", "Mag-aalahas", "Mangangalakal"],
                answer: "Mag-aalahas"
            },
            {
                question: "Ang binata na nagsikap na maitatag ang Akademya ng Wikang Kastila.",
                options: ["Basilio", "Isagani", "Pelaez"],
                answer: "Isagani"
            },
            {
                question: "Ang kasama ni Simoun sa paghihiganti sa mga prayle na labis na nagpahirap sa kanilang mga buhay.",
                options: ["Basilio", "Isagani", "Pelaez"],
                answer: "Basilio"
            },
            {
                question: "Siya ang prayle na nilapitan ni Juli upang makalaya si Basilio sa kamay ng mga tulisan.",
                options: ["Padre Camorra", "Padre Damaso", "Padre Sibyla"],
                answer: "Padre Camorra"
            },
            {
                question: "Upang maisagawa ang balak na paghihiganti kanino sumapi si Simoun?",
                options: ["Don Rafael", "Don Tiburcio", "Don Timoteo"],
                answer: "Don Timoteo"
            },
            {
                question: "Ilang buwan nakapiit sa kulungan si Basilio?",
                options: ["Dalawang buwan", "Isang buwan", "Tatlong buwan"],
                answer: "Dalawang buwan"
            },
            {
                question: "Ano ang dahilan ng kamatayan ni Juli?",
                options: ["Pagbigti sa sarili", "Pag-inom ng lason", "Pagpapatihulog sa kumbento"],
                answer: "Pagpapatihulog sa kumbento"
            },
            {
                question: "Sa ilog na ito inihagis ni Isagani ang lampara at doon pinasabog?",
                options: ["Ilog Asotea", "Ilog Bay", "Ilog Pasig"],
                answer: "Ilog Asotea"
            },
            {
                question: "Ang layunin ni Simoun sa Pamahalaan makalipas ang labintatlong taon na pagtatago.",
                options: ["Makipagkasundo sa mga Prayle", "Pag-anib sa Pamahalaan", "Paghihimagsik"],
                answer: "Paghihimagsik"
            }
        ];
