...
<head>
    ...
    <title>Kabanata 32 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 32 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang natuwa nang hindi makapasa sa Unibersidad at sinunog pa ang mga aklat nito?",
                options: ["Makaraig", "Pelaez", "Tadeo"],
                answer: "Tadeo"
            },
            {
                question: "Sino lamang ang nakapasa sa unibersidad?",
                options: ["Isagani at Sandoval", "Makaraig at Isagani", "Pelaez at Tadeo"],
                answer: "Isagani at Sandoval"
            },
            {
                question: "Sino ang tumutulong kay Basilio upang malaman ang mga nangyayari sa labas ng kulungan?",
                options: ["Isagani", "Kutserong si Sinong", "Makaraig"],
                answer: "Kutserong si Sinong"
            },
            {
                question: "Sino ang nabalitaan na ikakasal sa bayan?",
                options: ["Basilio at Paulita", "Isagani at Paulita", "Juanito at Paulita"],
                answer: "Juanito at Paulita"
            },
            {
                question: "Sino ang magiging ninong sa kasal nila Juanito at Paulita?",
                options: ["Ben Zayb", "Kapitan Heneral", "Simoun"],
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_32.php"; // Replace with the actual href link
