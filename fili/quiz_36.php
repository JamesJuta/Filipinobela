...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 36 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang tumakbo papunta sa kanyang bahay matapos malaman ang mga pangyayari?",
                options: ["Ben Zayb", "Isagani", "Kapitan Tiyago"],
                answer: "Ben Zayb"
            },
            {
                question: "Sino ang tinutukoy ni Ben Zyab sa kanyang sinulat na naging bayani sa pangyayari?",
                options: ["Kapitan Heneral", "Padre Salvi", "Tadeo"],
                answer: "Kapitan Heneral"
            },
            {
                question: "Sino ang nagbawal na banggitin ang nangyari ng gabing iyon?",
                options: ["Kapitan Heneral", "Kutserong si Sinong", "Simoun"],
                answer: "Kapitan Heneral"
            },
            {
                question: "Sino ang natagpuan na sugatan sa Ilog Pasig, ayon sa salaysay ni Ben Zayb?",
                options: ["Padre Camorra", "Padre Irene", "Padre Salvi"],
                answer: "Padre Camorra"
            },
            {
                question: "Siya ang naghanda ng habla laban sa mag-aalahas?",
                options: ["Don Custodio", "Kapitan Heneral", "Simoun"],
                answer: "Don Custodio"
            }
        ];
