...
<head>
    ...
    <title>Kabanata 3 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 3 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ang alamat na isinalaysay ng Kapitan.",
                options: ["Alamat ng Bayad", "Alamat ng Kabukiran", "Alamat ng Malapad na Bato"],
                answer: "Alamat ng Malapad na Bato"
            },
            {
                question: "Sino ang nagsalaysay ng alamat ni Donya Geronima?",
                options: ["Padre Florentino", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Florentino"
            },
            {
                question: "Sino ang ibig manirahan sa kweba dahil sa alamat na kanilang nalaman?",
                options: ["Donya Clara", "Donya Geronima", "Donya Victorina"],
                answer: "Donya Victorina"
            },
            {
                question: "Sino ang magiting na nagligtas sa isang Intsik mula sa buwaya?",
                options: ["San Diego", "San Nicolas", "San Rafael"],
                answer: "San Rafael"
            },
            {
                question: "Ano ang natuklasan ni Simoun kay Padre Salvi at Ben Zayb?",
                options: ["Magkasama ang bangkay nila mag-ama at inilibing sa pinakamurang libingan", "Marami ang may galit sa mag-ama kung kaya't inuusig sila ng mga tao sa kanilang lugar", "Tumatak sa mga tao ang magandang nagawa ng mag-ama at binigyan ito ng parangal ng pagkilala"],
                answer: "Magkasama ang bangkay nila mag-ama at inilibing sa pinakamurang libingan"
            }
        ];
