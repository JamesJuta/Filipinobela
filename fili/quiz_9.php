...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 9 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang humamak sa katauhan ni Basilio?",
                options: ["Hermana Penchang", "Kapitan Tiyago", "Tandang Selo"],
                answer: "Hermana Penchang"
            },
            {
                question: "Kung hindi daw umalis si __ ay mawawalan ng boses si Tandang Selo.",
                options: ["Basilio", "Hermana Penchang", "Kabesang Tales"],
                answer: "Kabesang Tales"
            },
            {
                question: "Saan nakakuha ng pantubos si Juli para sa kanyang ama?",
                options: ["Hiram na salapi mula kay Simoun", "Napagbilhan na Alahas at nautang na pera kay Hermana Penchang", "Napagbilhang hayop at nakaw na pera"],
                answer: "Napagbilhan na Alahas at nautang na pera kay Hermana Penchang"
            },
            {
                question: "Ilang araw binigyan ng palugid ng mga prayle ang mag-ama upang umalis sa kanilang tinitirahan?",
                options: ["Dalawang araw", "Isang araw", "Tatlong araw"],
                answer: "Tatlong araw"
            },
            {
                question: "Sino ang bagong may-ari ng lupa ni Kabesang Tales?",
                options: ["Mga Dominikano", "Mga Kastila", "Mga Pari"],
                answer: "Mga Pari"
            }
        ];
