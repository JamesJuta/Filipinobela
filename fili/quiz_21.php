...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 21 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saang Teatro itatanghal ang dulang Les Choches de Corneville?",
                options: ["Teatro de la Ciudad", "Teatro de la Maestranza", "Teatro de Variendades"],
                answer: "Teatro de Variendades"
            },
            {
                question: "Sino ang pumasok sa tanghalan na tila mukang pulubi?",
                options: ["Camarroncocido", "Quiroga", "Tiyo Kiko"],
                answer: "Camarroncocido"
            },
            {
                question: "Ano ang sabi o komento ni Don Custodio?",
                options: ["Maganda at may aral", "Masagwa at labag sa moralidad", "Masaya at nagtutulungan"],
                answer: "Masagwa at labag sa moralidad"
            },
            {
                question: "Ilang tao ang nag-uusap tungkol sa mga kura at sa Heneral?",
                options: ["Dalawa", "Lima", "Tatlo"],
                answer: "Dalawa"
            },
            {
                question: "Sino ang hindi sumama para manood ng palabas sa Teatro?",
                options: ["Basilio", "Simoun", "Tadeo"],
                answer: "Basilio"
            }
        ];
