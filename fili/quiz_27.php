...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 27 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang katedratikong Padre na ipinatawag si Isagani?",
                options: ["Padre Damaso", "Padre Fernandez", "Padre Salvi"],
                answer: "Padre Fernandez"
            },
            {
                question: "Sino ang paboritong estudyante ni Padre Fernandez?",
                options: ["Basilio", "Isagani", "Pelaez"],
                answer: "Isagani"
            },
            {
                question: "Ano ang kahulugan ng pagbabalatkayo?",
                options: ["Pagkukunwari", "Pagsisinungaling", "Pinupuna"],
                answer: "Pagkukunwari"
            },
            {
                question: "Ano ang ibig sabihin ng katedratiko?",
                options: ["Kagalang-galang propesor", "Mahigpit na propesor", "Paring propesor"],
                answer: "Paring propesor"
            },
            {
                question: "Ano ang kahulugan ng tinutuligsa?",
                options: ["Ginipit", "Ipininid", "Pinupuna"],
                answer: "Pinupuna"
            }
        ];
