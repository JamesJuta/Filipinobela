...
<head>
    ...
    <title>Kabanata 6 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 6 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ilang taon nang patay ang ina ni Basilio na si Sisa?",
                options: ["Labing-isang taon", "Labing-limang taon", "Labing-tatlong taon"],
                answer: "Labing-tatlong taon"
            },
            {
                question: "Sa unang taon ng pag-aaral ni Basilio ano ang kanyang palaging nabibigkas?",
                options: ["'admaestra' o aking guro", "'admaiora' o ang aking birhen", "'adsum' o narito po"],
                answer: "'adsum' o narito po"
            },
            {
                question: "Sino ang naging guro ni Basilio na nililito subalit hindi nasindak?",
                options: ["Gurong Dominikano", "Gurong Kastila", "Prayleng Guro"],
                answer: "Gurong Dominikano"
            },
            {
                question: "Ano ang nakamit ni Basilio dahil sa labis na katalinuhan?",
                options: ["Magresaliente", "Sobresaliente", "Veliersaliente"],
                answer: "Sobresaliente"
            },
            {
                question: "Ang Unibersidad na pinasukan ni Basilio.",
                options: ["Ateneo Municipal", "Letran Municipal", "Sto. Tomas Municipal"],
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_6.php"; // Replace with the actual href link
