...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 1 - El Filibusterismo</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan naglayag ang Bapor Tabo noong umaga ng Disyembre?",
                options: ["Ilog ng Makati", "Ilog Pasig", "Lawa ng Laguna"],
                answer: "Ilog Pasig"
            },
            {
                question: "Saan patutungo ang Bapor Tabo?",
                options: ["Laguna", "Makati", "Manila"],
                answer: "Laguna"
            },
            {
                question: "Alin sa mga sumusunod ang hindi kasama sa ibabaw ng kubyerta?",
                options: ["Ben Zayb", "Elias", "Simoun"],
                answer: "Elias"
            },
            {
                question: "Ano ang iminungkahi ni Simoun na mag-uugnay sa lawa ng Laguna at look ng Maynila?",
                options: ["Tuwid na Daan", "Tuwid na Kanal", "Tuwid na Tulay"],
                answer: "Tuwid na Kanal"
            },
            {
                question: "Ano ang kanilang ipinakain sa alagang itik?",
                options: ["Bulate", "Halaman", "Suso"],
                answer: "Suso"
            }
        ];
