...
<head>
    ...
    <title>Kabanata 5 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 5 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saan ginanap ang prusisyon bago mag-noche buena?",
                options: ["San Diego", "San Nicolas", "San Rafael"],
                answer: "San Diego"
            },
            {
                question: "Sino ang pinaka-matandang nabuhay sa mundo?",
                options: ["Magdalena", "Medusa", "Metusalem"],
                answer: "Metusalem"
            },
            {
                question: "Sino ang pinaniniwalaan ng hari na makapagpapalaya diumano sa bayan?",
                options: ["Bernardo Carpio", "Isagani", "Simoun"],
                answer: "Bernardo Carpio"
            },
            {
                question: "Sino ang natagpuan ni Basilio sa bahay ni Kapitan Tiyago?",
                options: ["Alperes, Kura at Simoun", "Juli, Elias at Simoun", "Kura, Isagani at Simoun"],
                answer: "Alperes, Kura at Simoun"
            },
            {
                question: "Alin ang hindi kasama sa loob ng bahay ng Kapitan?",
                options: ["Ang gubat ng mga Ibarra", "Ang pagdakip kay Kabesang Tales ng mga tulisan", "Ang pagkamatay ng maraming hayop"],
                answer: "Ang gubat ng mga Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_5.php"; // Replace with the actual href link
