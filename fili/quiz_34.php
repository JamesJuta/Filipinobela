...
<head>
    ...
    <title>Kabanata 34 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 34 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Dalawang oras na lang at sasabog na ang ilawan ni Simoun. Sinalat ni Basilio ang kanyang rebolber at naalala ang babala ni Simoun na lumayo siya sa daang ___.",
                options: ["Anloague", "Gilid", "Ibaba"],
                answer: "Anloague"
            },
            {
                question: "Ano ang kahulugan ng salitang nag-aatubili?",
                options: ["Hindi makapag-desisyon", "Naghahangad ng karangalan", "Walang maisip na gawin"],
                answer: "Hindi makapag-desisyon"
            },
            {
                question: "Nasambit ni Basilio kay Simoun na naging masama siyang anak dahil hindi niya ipinaghiganti ang kasawian ng kanyang ina at kapatid. Sa kanyang pag-iwas kay Simoun at sa mga plano nito ay wala umano siyang napala kundi ang ___.",
                options: ["Pagkabalisa", "Pagkakulong", "Pagtatago"],
                answer: "Pagkakulong"
            },
            {
                question: "Nakita niya ang pagdating ng sasakyan ng bagong kasal. Naisip niya ang kaibigang si Isagani.",
                options: ["Naawa", "Nagalit", "Natuwa"],
                answer: "Naawa"
            },
            {
                question: "Nagtungo din si Basilio sa ___ sa bahay ni Kapitan Tiyago.",
                options: ["Anloague", "Sulok", "Taas"],
                answer: "Anloague"
            }        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_34.php"; // Replace with the actual href link
