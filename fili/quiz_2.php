...
<head>
    ...
    <title>Kabanata 2 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 2 - El Filibusterismo</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PILIIN ANG WASTONG SAGOT SA BAWAT BILANG.</h2><br>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang natagpuan sa ilalim ng kubyerta?",
                options: ["Basilio", "Elias", "Simoun"],
                answer: "Basilio"
            },
            {
                question: "Sino ang Maganda at mayamang kasintahan ni Isagani?",
                options: ["Laura", "Maria Clara", "Paulita Gomez"],
                answer: "Paulita Gomez"
            },
            {
                question: "Sino ang nagbalita na kaya tamad ang mga Pilipino ay dahil pala-inom ng tubig at hindi serbesa?",
                options: ["Padre Camorra", "Padre Damaso", "Padre Salvi"],
                answer: "Padre Camorra"
            },
            {
                question: "Sino ang asawa ni Donya Victorina na ipinapahanap kay Isagani?",
                options: ["Don Diego", "Don Florentino", "Don Tiburcio"],
                answer: "Don Tiburcio"
            },
            {
                question: "Sino ang mag-aalahas?",
                options: ["Don Moreno", "Kardinal Moreno", "Koronel Moreno"],
                answer: "Kardinal Moreno"
            }
        ];
