...
<head>
    ...
    <title>Kabanata 38 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 38 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Kinuha ng ___ ang lahat ng pinaghinalaang tulisan para maitago ang kanilang kahinaan.",
                options: ["Mamamayan", "Pamahalaan", "Prayle"],
                answer: "Pamahalaan"
            },
            {
                question: "Matapos ang pagsalakay ni ___ ay anim o pitong mga magsasaka ang dinakip ng mga sibil.",
                options: ["Don Custodio", "Kabesang Tales", "Kapitan Heneral"],
                answer: "Kabesang Tales"
            },
            {
                question: "Ayon kay Mautang, isa sa mga Pilipinong ___, may karapatan silang abusuhin ang mga bilanggo.",
                options: ["Prayle", "Propesor", "Sibil"],
                answer: "Sibil"
            },
            {
                question: "Sampu o ___ mga gwardia sibil naman na mga Pilipino ang nang-aabuso sa mga bilanggo at pilit na pinapaamin na sila ang mga tulisan.",
                options: ["Labindalawang", "Labinpito", "Labinsiyam"],
                answer: "Labindalawang"
            },
            {
                question: "Mukhang kilala ni Carolino kung sino ang taong nasa bundok ngunit hindi niya masyadong maaninagan dahil sa init ng araw. Nang tingnan niya ang mga nakahandusay, nakita niya sa mga iyon ang kanyang ___.",
                options: ["Lolo Ben", "Lolo Juan", "Lolo Selo"],
                answer: "Lolo Selo"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_38.php"; // Replace with the actual href link
