...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 35 - El Filibusterismo</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: BUUIN ANG PANGUNGUSAP SA PAMAMAGITAN NG PAGPILI NG WASTONG SAGOT.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Lahat ng mga bisita ay pinagpupugayan ni ___.",
                options: ["Don Custodio", "Don Tiburcio de Espadaña", "Don Timoteo"],
                answer: "Don Timoteo"
            },
            {
                question: "Mayroong pumintas sa mga ___ sa pader. Nagalit ang Don at sinabing iyon daw ang pinakamahal na mabibili sa Maynila.",
                options: ["Bulaklak", "Kromo", "Obra"],
                answer: "Kromo"
            },
            {
                question: "Naawa siya sa mga inakala niyang mga walang malay na mamamatay roon kaya naisip niyang bigyan sila ng babala. Ngunit ng makita niya sina ___ at ___ ay nagbago ang kanyang isip.",
                options: ["Padre Camorra at Padre Florentino", "Padre Fernandez at Padre Millon", "Padre Salvi at Padre Irene"],
                answer: "Padre Salvi at Padre Irene"
            },
            {
                question: "Nalimot na naman ni Basilio ang ___ dinanas ng kanyang ina, kapatid, at ni Juli.",
                options: ["Kalungkutan", "Kapighatiang", "Kasiyahang"],
                answer: "Kapighatiang"
            },
            {
                question: "Sa loob ng bahay ay may nakita ang mga nagpipiging na isang kaputol na ___ na may nakasulat na ikinatakot ng mga tao sa loob ng bahay ni Kapitan Tiyago.",
                options: ["Dahon", "Papel", "Tela"],
                answer: "Papel"
            }
        ];
