...
<head>
    ...
    <title>Kabanata 12 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 12 - El Filibusterismo</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saan patutungo si Placido Penitente?",
                options: ["Unibersidad ng Ateneo", "Unibersidad ng Letran", "Unibersidad ng Santo Tomas"],
                answer: "Unibersidad ng Santo Tomas"
            },
            {
                question: "Ano ang kursong kinuha ni Placido Penitente?",
                options: ["Batsilyer ng Teknolohiya", "Batsilyer ng Artes", "Batsilyer ng Matematika"],
                answer: "Batsilyer ng Artes"
            },
            {
                question: "Sino ang mayaman at paborito ng mga guro?",
                options: ["Basilio", "Juanito", "Placido"],
                answer: "Juanito"
            },
            {
                question: "Sino ang tiyahin ni Paulita na kasama nya sa loob ng karwaheng papasok sa Unibersidad?",
                options: ["Donya Carina", "Donya Flerida", "Donya Victorina"],
                answer: "Donya Victorina"
            },
            {
                question: "Ilan ng bilang nila Placido sa kanilang klase?",
                options: ["Dalawang-daan at limampu", "Isang-daan at limampu", "Tatlong-daan at limampu"],
                answer: "Isang-daan at limampu"
            }
        ];
