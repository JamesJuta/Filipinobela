...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 12 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sa sementeryo, anong malaking bagay ang nakatirik sa gitna nito?",
                options: ["Krus", "Lapida", "Rebulto"],
                answer: "Krus"
            },
            {
                question: "Ilang tao ang abala sa paghuhukay sa sementeryo?",
                options: ["Anim", "Apat", "Pinagdusahan"],
                answer: "Dalawa"
            },
            {
                question: "Siya ang tinutukoy ni Padre Garrote na nag-utos na hukayin ang bangkay.",
                options: ["Padre Damaso", "Padre Florentino", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang nananangis?",
                options: ["Nagdadalamhati", "Nagsisibat", "Nagsusunog"],
                answer: "Nagdadalamhati"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang nangita?",
                options: ["Hinanap", "Naggunita", "Sinigawan"],
                answer: "Hinanap"
            }
        ];
