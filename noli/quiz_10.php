...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 10 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang naging trabaho o ikinabubuhay ng mga taong hindi nakapag-aral?",
                options: ["Pagiging alipin", "Pagsasaka", "Pagtulong sa simbahan"],
                answer: "Pagsasaka"
            },
            {
                question: "Sino ang ama ni Don Rafael na lolo naman ni Ibarra?",
                options: ["Bernardo", "Filipo", "Saturnino"],
                answer: "Saturnino"
            },
            {
                question: "Ano ang naging sanhi ng inggit at galit ng mga tao kay Don Rafael?",
                options: ["Determinsyon nito", "Pagiging patas nito", "Pamumuno nito"],
                answer: "Pamumuno nito"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang atipan?",
                options: ["Lagayan ng bubong", "Lagayan ng libro", "Lagayan ng pagkain"],
                answer: "Lagayan ng bubong"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang matatas?",
                options: ["Matalas ang dila", "Matalas ang isipan", "Malinaw magsalita"],
                answer: "Malinaw magsalita"
            }
        ];
