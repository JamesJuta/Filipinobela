...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 6 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang negosyo ng mga magulang ni Kapitan Tiyago?",
                options: ["Asukal", "Gulay", "Opium"],
                answer: "Asukal"
            },
            {
                question: "Sino ang asawa ni Kapitan Tiyago na ina ni Maria Clara?",
                options: ["Pia Alba", "Pia Alfa", "Pia Alma"],
                answer: "Pia Alba"
            },
            {
                question: "Ano ang kursong  kinuha ni Ibarra sa Europa?",
                options: ["Manunulat", "Medisina", "Militarya"],
                answer: "Medisina"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang kawaksi ay ___?",
                options: ["Kaaway", "Kasama", "Katulong"],
                answer: "Katulong"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang tinutuligsa ay ___?",
                options: ["Hinahabol", "Pinupuksa", "Pinupuna"],
                answer: "Pinupuna"
            }
        ];
