...
<head>
    ...
    <title>Kabanata 57 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
             <h1><center>Pagsusulit sa Kabanata 57 - Noli Me Tangere</u></center></h1>
         </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang bihag na kanilang tinanong kung may kinalaman si Ibarra sa nasabing paglusob?",
                options: ["Pursing", "Rodolfo", "Tarsilo"],
                answer: "Tarsilo"
            },
            {
                question: "Sino ang nakita ni Tarsilo sa limang bangkay na kanyang nakita nap uno ng saksak?",
                options: ["Bruno", "Lucas", "Pedro"],
                answer: "Bruno"
            },
            {
                question: "Sino ang asawa ni Sisa na nakita rin sa loob ng silid na puno ng bangkay?",
                options: ["Bruno", "Lucas", "Pedro"],
                answer: "Pedro"
            },
            {
                question: "Sino ang bangkay na nakita ni Tarsilo na may tali pa sa leeg?",
                options: ["Bruno", "Lucas", "Pedro"],
                answer: "Lucas"
            },
            {
                question: "Saan nalagutan ng hininga si Tarsilio?",
                options: ["Sa Balon na nakakasuka ang amoy", "Sa kumbento", "Sa piitan"],
                answer: "Sa Balon na nakakasuka ang amoy"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_57.php"; // Replace with the actual href link
