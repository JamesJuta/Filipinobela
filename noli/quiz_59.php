...
<head>
    ...
    <title>Kabanata 59 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 59 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang ipagbubunyi at karapat-dapat na bigyan ng isang mitra?",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Salvi"
            },
            {
                question: "May kumakalat na ang mga nag-aaral diumano sa ___ ay nagiging pilibustero.",
                options: ["Ateneo", "La Salle", "Letran"],
                answer: "Letran"
            },
            {
                question: "Sa balitang paglusob ng mga sawimpalad si Kapitan ___ ay hindi mapakali dahil sa mga nangyayari.",
                options: ["Kapitan-Heneral", "Kapitan Tinong", "Kapitan Tiyago"],
                answer: "Kapitan Tinong"
            },
            {
                question: "Sino ang pinsan ni Kapitan Tinong na mahilig gumamit ng salitang Latin?",
                options: ["Don Fernando", "Don Primitivo", "Don Tiburcio"],
                answer: "Don Primitivo"
            },
            {
                question: "Saan nagkaroon ng pag-uusap tungkol sa pag-aalsa ang mga dalaga, mga asawa at mga anak ng kawani?",
                options: ["Maalamat na gubat", "Pamahalaan", "Intramuros"],
                answer: "Intramuros"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_59.php"; // Replace with the actual href link
