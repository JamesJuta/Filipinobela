...
<head>
    ...
    <title>Kabanata 61 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 61 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan nais itago ni Elias si Ibarra?",
                options: ["Laguna", "Mandaluyong", "Maynila"],
                answer: "Mandaluyong"
            },
            {
                question: "Sino ang nagpatigil kina Elias nang mapadaan ito sa tapat ng palasyo?",
                options: ["Guwardiya Sibil", "Kastila", "Polvorista"],
                answer: "Polvorista"
            },
            {
                question: "Sa tapat ng bahay-bakasyunan ng mga __ ay naalala ni Elias ang masasayang araw na dinanas niya.",
                options: ["Kastila", "Heswitas", "Prayle"],
                answer: "Heswitas"
            },
            {
                question: "Saan magkikita sina Ibarra at Elias pagtapos ng Noche Buena?",
                options: ["Libingan ng nuno ni Ibarra", "Mahiwagang Gubat", "Malinis na Ilog Pasig"],
                answer: "Libingan ng nuno ni Ibarra"
            },
            {
                question: "Sino ang nakapansin na may bahid ng dugo ang baybayin ng pampang?",
                options: ["Guwardiya Sibil", "Kastila", "Polvorista"],
                answer: "Guwardiya Sibil"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_61.php"; // Replace with the actual href link
