...
<head>
    ...
    <title>Kabanata 35 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 35 - Noli Me Tangere</u></center></h1>
        </div>
        ...
        <div id="question" class="quiz_form" style="text-align: left;"></div>
            <form id="quiz-form" >
    ...
    <script>
        const questions = [
            {
                question: "Bakit mas pinanigan ng mga tao sa San Diego si Padre Damaso kaysa kay Ibarra?",
                options: ["Dahil mas makapangyarihan ang kura kaysa kay Ibarra ", "Dahil si Ibarra ay hindi nakikipag-usap kay Kapitan Tiyago", "Dahil hindi maruning magtimpi si Ibarra sa nangyari"],
                answer: "Dahil hindi maruning magtimpi si Ibarra sa nangyari"
            },
            {
                question: "Sino ang tanging nakaintindi kay Ibarra sa kanyang ikinilos at isinaad na walang sinuman ang hindi makakapagpigil kung ang ama ang lalapastanganin?",
                options: ["Kapitan Martin", "Don Filipo", "Kapitan Tiyago"],
                answer: "Kapitan Martin"
            },
            {
                question: "Sino ang nagpahayag na nangyayari ang lahat dahil hindi nagkakaisa at watak-watak ang mga mga taumbayan samantalang ang mga prayle at mayayaman ay nagkakabuklod-buklod?",
                options: ["Kapitan Martin", "Don Filipo", "Kapitan Tiyago"],
                answer: "Don Filipo"
            },
            {
                question: "Natakot ang mga matatandang babae na di nila panigan si Padre Damaso na baka mapunta sila sa __?",
                options: ["Purgatoryo", "Impyerno", "Langit"],
                answer: "Impyerno"
            },
            {
                question: "Bakit hindi matutuloy ang pagpapatayo ng paaralan?",
                options: ["Dahil tinawag na pilibustero si Ibarra", "Dahil umalis na si Nol Juan", "Dahil ito ay pinigilan ni Padre Damaso"],
                answer: "Dahil tinawag na pilibustero si Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_35.php"; // Replace with the actual href link
