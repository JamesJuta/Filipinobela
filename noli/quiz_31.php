...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 31 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano-anong wika ang ginamit ni Padre Damaso sa pagsermon niya sa misa?",
                options: ["Kastila lamang", "Tagalog at Kastila", "Tagalog lamang"],
                answer: "Tagalog at Kastila"
            },
            {
                question: "Siya ang tapat na mananampalataya.",
                options: ["Gideon", "Ibarra", "Roldan"],
                answer: "Roldan"
            },
            {
                question: "Siya ng tinuligsa ni Padre Damaso sa kanyang misa.",
                options: ["Elias", "Ibarra", "Maria Clara"],
                answer: "Ibarra"
            },
            {
                question: "Sino ang hindi natutuwa sa nagaganap sa misa kung kayat nagkuliling na lamang ito?",
                options: ["Don Filipo", "Kapitan Tiyago", "Padre Salvi"],
                answer: "Padre Salvi"
            },
            {
                question: "Ilang oras ang inabot ni Padre Damaso sa kanyang panenermon sa isinasagawang misa?",
                options: ["Kalahating oras", "Isa at kalahating oras", "Isang oras"],
                answer: "Kalahating oras"
            }
        ];
