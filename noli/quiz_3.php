...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 3 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang dahilan ng pagka-alburoto ni Padre Damaso?",
                options: ["Dahil hindi siya napapansin masyado", "Dahil mga leeg at pakpak ang laman ng kanyang tinola", "Dahil nasusuway ang kanyang utos"],
                answer: "Dahil mga leeg at pakpak ang laman ng kanyang tinola"
            },
            {
                question: "Sa hapag-kainan, ano ang ginawa ni Ibarra?",
                options: ["Kumanta para sa mga bisita", "Nag-anunsyo ng magandang balita", "Nag-kwento ng kanyang buhay sa ibang bansa"],
                answer: "Nag-kwento ng kanyang buhay sa ibang bansa"
            },
            {
                question: "Pangalan ng pahayagan kung saan dito nagsusulat si Ibarra?",
                options: ["Estudios Coloniales", "La Nación", "La Tercera de la Hora"],
                answer: "Estudios Coloniales"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang kapalaluan?",
                options: ["Kayabanagan", "Nabulunukan", "Napalalunan"],
                answer: "Kayabanagan"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang naibulalas?",
                options: ["Naibato", "Nakita", "Nasambit"],
                answer: "Nasambit"
            }
        ];
