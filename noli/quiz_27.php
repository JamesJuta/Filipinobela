...
<head>
    ...
    <title>Kabanata 27 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 27 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Bakit sinasadyang higitan ni Kapitan Tiyago ang paghahanda sa kapistahan?",
                options: ["Dahil sa masasarap na handa", "Dahil sa pagtanggap ng mga tao kay Ibarra", "Dahil sa pinamigay na munting sorpresa ni Ibarra"],
                answer: "Dahil sa pagtanggap ng mga tao kay Ibarra"
            },
            {
                question: "Sino ang napagtanungan ni Sisa upang mahanap ang kanyang mga anak?",
                options: ["Ibarra", "Ketongin", "Sakristan mayor"],
                answer: "Ketongin"
            },
            {
                question: "Kanino binigay ni Maria Clara ang kwintas na regalo ng kanyang ama?",
                options: ["Iday", "Ketongin", "Sisa"],
                answer: "Ketongin"
            },
            {
                question: "Ang kasing kahulugan ng salitang kinumbida ay ___?",
                options: ["Inimbita", "Kinompronta", "Kinumpara"],
                answer: "Inimbita"
            },
            {
                question: "Ang kasing kahulugan ng salitang salakot ay ___?",
                options: ["Kahon", "Palakol", "Sumbrero"],
                answer: "Sumbrero"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_27.php"; // Replace with the actual href link
