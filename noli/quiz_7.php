...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 7 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sawimpalad",
                options: ["Nabigo", "Nadismaya", "Nalungkot"],
                answer: "Nabigo"
            },
            {
                question: "Nagpapasikdo",
                options: ["Nagpapatibok", "Nagtitirik", "Natigilan"],
                answer: "Nagpapatibok"
            },
            {
                question: "Alumpihit",
                options: ["Di Mapalagay", "Makulit", "Nararamdaman"],
                answer: "Di Mapalagay"
            },
            {
                question: "Mag-ulayaw",
                options: ["Mag-banlaw", "Mag-usap", "Sumayaw"],
                answer: "Mag-usap"
            },
            {
                question: "Ulupong",
                options: ["Laruan", "Makamandag", "Sakit"],
                answer: "Makamandag"
            }
        ];
