...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 29 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang ipinagdiriwang sa araw na iyon?",
                options: ["Kaarawan", "Kapistahan", "Kasalan"],
                answer: "Kapistahan"
            },
            {
                question: "Sino ang nagsabi na paglulustay lamang ng salapi at pagpapakitang tao ang pagdaraos ng kapistahan na iyon?",
                options: ["Don Filipo", "Padre Damaso", "Pilosopo Tasyo"],
                answer: "Pilosopo Tasyo"
            },
            {
                question: "Saang lugar mayroong pagdiriwang ng kapistahan?",
                options: ["San Diego", "San Jose", "San Simon"],
                answer: "San Diego"
            },
            {
                question: "Saan tumigil ang prusisyon ng iba't ibang santo?",
                options: ["Tapat ng bahay ni Kapitan Tiyago", "Sa Palasyo", "Sa Simbahan ng San Diego"],
                answer: "Tapat ng bahay ni Kapitan Tiyago"
            },
            {
                question: "Sino ang sumang-ayon sa pananaw ni Pilosopo Tasyo?",
                options: ["Don Filipo", "Elias", "Ibarra"],
                answer: "Don Filipo"
            }
        ];
