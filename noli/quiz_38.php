...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 38 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang hudyat ng pagsisimula ng prusisyon?",
                options: ["Ang pagpapaputok", "Ang tunog ng kampana ", "Ang tunong ng kampana at ang pagpapaputok"],
                answer: "Ang tunong ng kampana at ang pagpapaputok"
            },
            {
                question: "Sino ang napilitan lamang sumama dahil sa pag-imbita sa kaniya ng Heneral?",
                options: ["Alperes", "Ibarra", "Kapitan Tiyago"],
                answer: "Ibarra"
            },
            {
                question: "Ang loa ay isang ___?",
                options: ["Kantang papuri", "Kwentong papuri", "Tulang papuri"],
                answer: "Tulang papuri"
            },
            {
                question: "Ang pila ng prusisyon ay pinangungunahan ng tatlong sacristan sinundan ng __ at mga batang may dalang parol.",
                options: ["Guro", "Prayle", "Sibil"],
                answer: "Guro"
            },
            {
                question: "Ano kinanta ni Maria Clara sa pagdaraos ng prusisyon?",
                options: ["Ave Maria", "Papuri Sa Diyos", "Salamat Panginoon"],
                answer: "Ave Maria"
            }
        ];
