...
<head>
    ...
    <title>Kabanata 40 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 40 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang nangasiwa sa gabi ng pista?",
                options: ["Don Filipo", "Don Rodolfo", "Don Tiyago"],
                answer: "Don Filipo"
            },
            {
                question: "Ano ang palabas na pinangunahan nina Chananay at Marianito?",
                options: ["Crispino dela Comare", "Feria De Sevilla", "Saynete"],
                answer: "Crispino dela Comare"
            },
            {
                question: "Sino ang nakatitig kay Maria Clara sa pagsasagawa ng dula?",
                options: ["Ibarra", "Kapitan Tiyago", "Padre Salvi"],
                answer: "Padre Salvi"
            },
            {
                question: "Ang kanyang pagdating ay nakaagaw ng pansin ng mga pari kaya hiniling ng mga ito na paalisin ang binati.",
                options: ["Bsilio", "Elias", "Ibarra"],
                answer: "Ibarra"
            },
            {
                question: "Nangakong babalik si Ibarra sa nalimutang tipanan matapos ang ___?",
                options: ["Dula", "Kausapin ang kura", "Kumain"],
                answer: "Dula"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_40.php"; // Replace with the actual href link
