...
<head>
    ...
    <title>Kabanata 22 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 22 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ngayon na ang araw ng pagdating nina Maria Clara at Tiya Isabel sa ______ upang mamalagi doon para sa pista ng bayan.",
                options: ["Maynila", "San Diego", "San Lozenzo"],
                answer: "San Diego"
            },
            {
                question: "Kumalat din umano ang madalas na pagkikita nila ni Ibarra na ikinagalit naman ni _______.",
                options: ["Kapitan Tiyago", "Padre Damaso", "Padre Salvi"],
                answer: "Padre Salvi"
            },
            {
                question: "Ano ang plano nina Maria Clara at Ibarra kasama ang kanilang mga kaibigan sa ilog?",
                options: ["Mangisda", "Magkantahan", "Mag-piknik"],
                answer: "Mag-piknik"
            },
            {
                question: "Sino ang nagsabi na huwag isama si Padre Salvi dahil naaabala daw siya nito kapag nasa paligid?",
                options: ["Ibarra", "Maria Clara", "Padre Damaso"],
                answer: "Maria Clara"
            },
            {
                question: "Sino ang nag-imbita kay Padre Salvi sa kanilang pinaplanong mag-piknik sa may ilog?",
                options: ["Ibarra", "Kapitan Tiyago", "Tiya Isabel"],
                answer: "Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_22.php"; // Replace with the actual href link
