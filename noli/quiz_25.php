...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 25 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Kanino tumungo si Ibarra at humingi ng payo sa paaralan na nais niya pasimulan?",
                options: ["Don Fernando", "Don Filipo", "Pilosopo Tasyo"],
                answer: "Pilosopo Tasyo"
            },
            {
                question: "Saan inihalintulad ni Pilosopo Tasyo ang buhay ni Ibarra?",
                options: ["Gumamela", "Rosas", "Sampaguita"],
                answer: "Rosas"
            },
            {
                question: "Ano ang ginawa ni Pilosopo Tasyo bago magpaalam si Ibarra?",
                options: ["Binigyan ng babala", "Binigyan ng inspirasyon", "Pinag-balot ng pagkain"],
                answer: "Binigyan ng inspirasyon"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang kalupi ang tangan?",
                options: ["Bayong", "Pitaka", "Sako"],
                answer: "Pitaka"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang tampalasang sanlibutan?",
                options: ["Mamamayan", "Masama", "Tagasunod"],
                answer: "Masama"
            }
        ];
