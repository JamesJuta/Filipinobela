...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 26 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Kailan ipinagdiwang ang pista ng San Diego?",
                options: ["Ika-labing lima ng Marso", "Ika-otso ng Abril", "Ika-sampu ng Nobyembre"],
                answer: "Ika-sampu ng Nobyembre"
            },
            {
                question: "Siya ang nagmisa noong umaga ng pista.",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Samantala, tinatapos na ang bahay-paaralan na pinapagawa ni Ibarra malapit sa kanyang tahanan sa pamamatnubay ni ______.",
                options: ["Guro", "Kapitan Tiyago", "Nol Juan"],
                answer: "Nol Juan"
            },
            {
                question: "Ang kasing kahulugan ng salitang gayak ay ___?",
                options: ["Itak o Patalim", "Maghanda", "Uri ng gulay"],
                answer: "Maghanda"
            },
            {
                question: "Ang kasing kahulugan ng salitang piitan ay ___?",
                options: ["Kulungan", "Opisina", "Silid-aralan"],
                answer: "Kulungan"
            }
        ];
