...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 32 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang gumagamit ng panghugos bago ganapin ang pagpapasinaya sa ginagawang paaralan?",
                options: ["Don Saturnino", "Kapitan Tiyago", "Nol Juan"],
                answer: "Nol Juan"
            },
            {
                question: "Sino ang nagbasbas sa bagong paaralan?",
                options: ["Padre Manuel", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Salvi"
            },
            {
                question: "Sino ang sumusubaybay sa kilos na ginagawa ng taong dilaw?",
                options: ["Elias", "Ibarra", "Kapitan Tiyago"],
                answer: "Elias"
            },
            {
                question: "Sino ang nais ipahuli ng alcalde dahil sa pagguho ng paaralan?",
                options: ["Elias", "Nol Juan", "Taong Dilaw"],
                answer: "Nol Juan"
            },
            {
                question: "Sino ang natamaan ng malaking bato at naging sanhi ng kanyang pagkamatay?",
                options: ["Elias", "Nol Juan", "Taong Dilaw"],
                answer: "Taong Dilaw"
            }
        ];
