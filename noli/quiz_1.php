...
<head>
    ...
    <title>Kabanata 1 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 1 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan matatagpuan ang bahay ni Kapitan Tiyago?",
                options: ["Kalye Anluwage", "Kalye Mabini", "Kalye Sampaguita"],
                answer: "Kalye Anluwage"
            },
            {
                question: "Kailan gaganapin ang pagtitipon sa malaking bahay ni Kapitan Tiyago?",
                options: ["Gabi", "Tanghali", "Umaga"],
                answer: "Gabi"
            },
            {
                question: "Bakit magkakaroon ng pagtitipon sa malaking bahay ni Kapitan Tiyago?",
                options: ["Dahil kaarawan niya", "Dahil pista sa kanilang lugar", "Upang magsilbing salubong sa paparating na binata galing Europa"],
                answer: "Upang magsilbing salubong sa paparating na binata galing Europa"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang piging?",
                options: ["Baboy", "Pagdadasal", "Pagtitipon"],
                answer: "Pagtitipon"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang walang turing?",
                options: ["Walang ginagawa", "Walang awa", "Walang utang na loob"],
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_1.php"; // Replace with the actual href link
