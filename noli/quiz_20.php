...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 20 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sino ang kasama ni Ibarra sa isang pagpupulong?",
                options: ["Guro", "Kapitan", "Kura"],
                answer: "Guro"
            },
            {
                question: "Ano ang nagsisilbing lugar para sa pagpupulong at pag-uusap ng mga mayayaman at makapangyarihan?",
                options: ["Hacienda", "Intramuros", "Tribunal"],
                answer: "Tribunal"
            },
            {
                question: "Saan ang gaganaping pagpupulong?",
                options: ["Kaarawan", "Kapistahan", "Pagtataas ng buwis"],
                answer: "Kapistahan"
            },
            {
                question: "Ilan ang gagawin sa araw ng prusisyon?",
                options: ["Dalawa", "Isa", "Tatlo"],
                answer: "Tatlo"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang liyampo?",
                options: ["Lampara", "Sugal intsik", "Uri ng karne"],
                answer: "Sugal intsik"
            }
        ];
