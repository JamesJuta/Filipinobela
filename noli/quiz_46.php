...
<head>
    ...
    <title>Kabanata 46 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 46 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang nagpabatid kay Ibarra na mayroong sakit si Maria Clara?",
                options: ["Elias", "Sinang", "Tiya Isabel"],
                answer: "Elias"
            },
            {
                question: "Sino ang nakasalubong ni Ibarra sa daan at tinanong kung magkanong salapi ang kanilang makukuha sa pagkamatay ng kaniyang kapatid?",
                options: ["Basilio", "Bruno", "Lucas"],
                answer: "Lucas"
            },
            {
                question: "Saan patutungo si Ibarra matapos sabihin ni Elias ang nangyari sa kaniyang kasintahan?",
                options: ["Sa bahay ni Kapitan Tiyago", "Sa ipinapatayong Paaralan", "Sa pamahalaan"],
                answer: "Sa bahay ni Kapitan Tiyago"
            },
            {
                question: "Ano ang makapagpapakasundo kina Ibarra at Lucas?",
                options: ["Ang pakiki-anib ni Lucas kay Ibarra", "Ang pagpapakulong kay Ibarra", "Ang salaping ibabayad ni Ibarra"],
                answer: "Ang salaping ibabayad ni Ibarra"
            },
            {
                question: "Ano ang dahilan ng galit ni Lucas kay Ibarra?",
                options: ["Ang dugong nananalaytay kay Ibarra", "Ang hindi nito pagbabayad", "Ang masamang hangarin ni Ibarra"],
                answer: "Ang dugong nananalaytay kay Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_46.php"; // Replace with the actual href link
