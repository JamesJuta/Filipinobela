...
<head>
    ...
    <title>Kabanata 24 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 24 - Noli Me Tangere</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: TUKUYIN KUNG SINO ANG HINAHANAP SA KATANUNGAN.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Sinong kura ang nagmisa ng umaga?",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Salvi"
            },
            {
                question: "Sino ang nais pakainin ni Ibarra ngunit dala ng paggiging wala sa katinuan ay agad itong umalis?",
                options: ["Elias", "Isagani", "Sisa"],
                answer: "Elias"
            },
            {
                question: "Sino ang nagsabing malaking kasalanan ang pakikialam sa pag-aari ng iba?",
                options: ["Albinos", "Isagani", "Pelaez"],
                answer: "Albino"
            },
            {
                question: "Sino ang nanakit kay Padre Damaso?",
                options: ["Elias", "Isagani", "Sisa"],
                answer: "Elias"
            },
            {
                question: "Sino ang nagkaroon ng matinding pagtatalo dahil sa pagkawala ng mga ni Sisa?",
                options: ["Don Fernando at Padre Sibyla", "Don Filipo at  Padre Damaso", "Don Filipo at Padre Salvi"],
                answer: "Don Filipo at Padre Salvi"
            }
        ];
