...
<head>
    ...
    <title>Kabanata 41 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
        <h1><center>Pagsusulit sa Kabanata 41 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang ginawa ni Ibarra ng gabing iyon ng hindi siya dinalaw ng antok?",
                options: ["Naglibang sa laboratoryo", "Naglibang sa pakikipagkwentuhan", "Naglibang sa pagsusulat"],
                answer: "Naglibang sa laboratoryo"
            },
            {
                question: "Sino ang dumating upang ipaalam kay Ibarra na si Maria ay may sakit?",
                options: ["Elias", "Isagani", "Padre Salvi"],
                answer: "Elias"
            },
            {
                question: "Si Ibarra nama’y nagmamadaling gumayak upang pumunta sa bahay ni __.",
                options: ["Alperes", "Kapitan Tiyago", "Sisa"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Sino ang kapatid ng taong dilaw na nakasalubong ni Ibarra?",
                options: ["Alfonso", "Juan", "Lucas"],
                answer: "Lucas"
            },
            {
                question: "Ano ang kahulugan ng salitang “Natubigan”?",
                options: ["Nabasa", "Natigilan", "Natapunan"],
                answer: "Natigilan"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_41.php"; // Replace with the actual href link
