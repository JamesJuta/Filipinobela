...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 5 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan nanuluyan si Ibarra?",
                options: ["Fonde de Laila", "Fonda de Lala", "Fonda de Lila"],
                answer: "Fonda de Lala"
            },
            {
                question: "Sino ang may-ari ng bahay na dinudurungawan ni Ibarra?",
                options: ["Don Filipo", "Donya Victorina", "Kapitan Tiyago"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Sino ang pari nagbighani kay Maria Clara?",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Salvi"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang panatag?",
                options: ["Magulo", "Nag-aaway", "Tiwasay"],
                answer: "Tiwasay"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang nakakalunos?",
                options: ["Nakakagalit", "Nakakalungkot", "Nakakapanghinayang"],
                answer: "Nakakapanghinayang"
            }
        ];
