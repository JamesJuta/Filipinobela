...
<head>
    ...
    <title>Kabanata 55 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 55 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan inimbitahan ni Sinang ang kaibigan na si Maria Clara upang kausapin?",
                options: ["Sa kuwarto", "Sa piyano", "Sa sala"],
                answer: "Sa piyano"
            },
            {
                question: "Sino ang palakad-lakad sa may bulwagan habang nagmamasid sa kanyang kapaligiran?",
                options: ["Padre Camorra", "Padre Damaso", "Padre Salvi"],
                answer: "Padre Salvi"
            },
            {
                question: "Sino ang tinangkang lapitan ni Maria Clara na luksang-luksa ang suot?",
                options: ["Ibarra", "Padre Salvi", "Sinang"],
                answer: "Ibarra"
            },
            {
                question: "Ano ang isinigaw ng mga kumedor na pumasok ng marinig ang mga putukan sa kumbento?",
                options: ["“Kastila”…”Kastila”…", "“Sibil” … “Sibil” …", "“Tulisan” … “Tulisan” …."],
                answer: "“Tulisan” … “Tulisan” …."
            },
            {
                question: "Sino ang mga tao na pilit nilulusob ang bahay ni Ibarra?",
                options: ["Gabinete", "Guwardiya Sibil", "Prayle"],
                answer: "Gabinete"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_55.php"; // Replace with the actual href link
