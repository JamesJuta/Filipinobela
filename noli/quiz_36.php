...
<head>
    ...
    <title>Kabanata 36 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 36 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang dumating sa bahay ni Kapitan Tiyago?",
                options: ["Kapitan Heneral", "Kapitan Tinong", "Padre Damaso"],
                answer: "Kapitan Heneral"
            },
            {
                question: "Sino ang nagbabawal kay Maria Clara na makipagkita kay Ibarra?",
                options: ["Kapitan Heneral", "Kapitan Tinong", "Kapitan Tiyago"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Ano ang naging desisyon ni Padre Damaso na kanyang inihayag kay Kapitan Tiyago?",
                options: ["Ang pagpasok ni Maria Clara sa kumbento", "Ang pagiging ekskomulgado ni Ibarra", "Ang pagpigil sa kasal ni Ibarra at Maria Clara"],
                answer: "Ang pagpigil sa kasal ni Ibarra at Maria Clara"
            },
            {
                question: "Ano ang iminungkahi ni Tiya Isabel na dahilan ng pagkagalit ni Kapitan Tiyago?",
                options: ["Ang kausapin si Ibarra", "Ang pagkonsinte nito kay Maria Clara", "Ang sulatan ang Arsobispo"],
                answer: "Ang sulatan ang Arsobispo"
            },
            {
                question: "Siya ang nagpapatawag kay Maria Clara upang ito ay kausapin.",
                options: ["Kapitan Heneral", "Kapitan Tinong", "Kapitan Tiyago"],
                answer: "Kapitan Heneral"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_36.php"; // Replace with the actual href link
