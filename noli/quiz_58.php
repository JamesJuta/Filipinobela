...
<head>
    ...
    <title>Kabanata 58 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 58 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sila ang pabalik-balik sa kumbento upang makahanap ng makakapitan na makatutulong para palayain ang kanilang mga kaanak na bilanggo?",
                options: ["Mga Guwardiya Sibil", "Mga pamilya ng mga sawimpalad", "Mga Prayle"],
                answer: "Mga pamilya ng mga sawimpalad"
            },
            {
                question: "Sino ang anak ni Kapitana Tinay na kasama sa paghuli ng mga sibil?",
                options: ["Antonio", "Diego", "Leonardo"],
                answer: "Diego"
            },
            {
                question: "Sino ang nakadamit na pangluksa sa nagpalagay na wala ng kaligtasan si Ibarra sa loob ng piitan?",
                options: ["Kapitan Tiyago", "Maria Clara", "Nol Juan"],
                answer: "Nol Juan"
            },
            {
                question: "Sino ang seminaristang nakagapos ng Mabuti tulad ng kambal ni Kapitana Maria?",
                options: ["Antonio", "Albano", "Alejandro"],
                answer: "Albano"
            },
            {
                question: "Sino ang sinisisi ng mga pamilya ng sawimpalad na utak ng pag-aalsa sa Pamahalaan?",
                options: ["Elias", "Ibarra", "Nol Juan"],
                answer: "Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_58.php"; // Replace with the actual href link
