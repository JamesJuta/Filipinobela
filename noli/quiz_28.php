...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 28 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Saan nalathala ang naganap na kapistahan ng San Diego?",
                options: ["Sa karatig bayan", "Sa Pahayagan", "Sa Pamahalaan"],
                answer: "Sa Pahayagan"
            },
            {
                question: "Bakit nasiyahan ang mga Kastila sa palabas na Komedya?",
                options: ["Dahil ang palabas ay idinaos sa wikang kastila", "Dahil sa magagaling na artista", "Dahil sa mga bihis nito"],
                answer: "Dahil ang palabas ay idinaos sa wikang kastila"
            },
            {
                question: "Siya ang namuno sa pagdaraos ng unang misa.",
                options: ["Padre Damaso", "Padre Martin", "Padre Salvi"],
                answer: "Padre Martin"
            },
            {
                question: "Sino ang nanguna sa sayawan sa araw ng pista?",
                options: ["Donya Victorina at Don Tiburcio", "Maria Clara at Ibarra", "Maria Clara at Kapitan Tiyago"],
                answer: "Maria Clara at Kapitan Tiyago"
            },
            {
                question: "Sino ang nais maimbitahan sa pagpapasinaya ng bahay-paaralan na ipinapatayo ni Ibarra?",
                options: ["Kapitan Heneral", "Kapitan Tiyago", "Maria Clara"],
                answer: "Maria Clara"
            }
        ];
