...
<head>
    ...
    <title>Kabanata 60 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 60 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang hindi nakuryente at hindi nabilanggo sa ilalim ng lupa?",
                options: ["Kapitan-Heneral", "Kapitan Tinong", "Kapitan Tiyago"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Ayon kay ___, kung babarililn diumano si Ibarra ay tama lang dahil ito daw ay isang pilibustero.",
                options: ["Donya Francia", "Donya Maria", "Donya Victorina"],
                answer: "Donya Victorina"
            },
            {
                question: "Sino ang tagapayo ni Kapitan Heneral?",
                options: ["Elias", "Ibarra", "Linares"],
                answer: "Linares"
            },
            {
                question: "Sino ang nagbahagi na hindi bibitayin si Ibarra?",
                options: ["Padre Damaso", "Padre Sibyla", "Tinyente Guevarra"],
                answer: "Tinyente Guevarra"
            },
            {
                question: "Ano ang dahilan ni Maria Clara sa pagpapakasal kay Linares?",
                options: ["Dahil sa kayamanan na kanyang makukuha sa angkan nila Linares", "Dahil sa labis na pag-ibig niya kay Linares", "Dahil sa ina niyang namayapa at sa dalawang ama niya na buhay pa"],
                answer: "Dahil sa ina niyang namayapa at sa dalawang ama niya na buhay pa"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_60.php"; // Replace with the actual href link
