...
<head>
    ...
    <title>Kabanata 63 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 63 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang batang nakaupo sa nakabuwal na kahoy dahil sa sugat sa paa?",
                options: ["Basilio", "Crispin", "Ibarra"],
                answer: "Basilio"
            },
            {
                question: "Siya ang nakatanggap ng sulat ni ___.",
                options: ["Basilio", "Linares", "Sinang"],
                answer: "Sinang"
            },
            {
                question: "Siya ang tumulong kay Basilio sa pagpapalibing sa kanyang ina?",
                options: ["Elias", "Crispin", "Ibarra"],
                answer: "Elias"
            },
            {
                question: "Saan natamaan ng alilang babae si Basilio na dahilan ng pagkawala ng kaniyang malay?",
                options: ["Dibdib", "Paa", "Ulo"],
                answer: "Ulo"
            },
            {
                question: "Saan nakabaon ang kayamanan na ginamit ni Basilio sa kanyang pag-aaral?",
                options: ["Bahay", "Lupa", "Puno ng balete"],
                answer: "Puno ng balete"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_63.php"; // Replace with the actual href link
