...
<head>
    ...
    <title>Kabanata 11 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 11 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [ 
            {
                question: "Sino ang makapangyarihan sa bayan ng San Diego?",
                options: ["Kapitan at Alkalde Mayor", "Kura paroko at Alperez", "Mga mayayaman sa San Diego"],
                answer: "Kura paroko at Alperez"
            },
            {
                question: "Sino ang kura paroko na pumalit kay Padre Damaso sa San Diego?",
                options: ["Padre Francisco", "Padre Salvi", "Padre Sybila"],
                answer: "Padre Salvi"
            },
            {
                question: "Sino ang asawa ng isang Filipina?",
                options: ["Donya Consolacion", "Donya Esperanza", "Donya Victorina"],
                answer: "Donya Consolacion"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang kakarampot?",
                options: ["Kakaunti", "Madami", "Madamot"],
                answer: "Kakaunti"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang nagbabando?",
                options: ["Nagagalit", "Naiyak", "Natutuwa"],
                answer: "Nagagalit"
            }
        ];
