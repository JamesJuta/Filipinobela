...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 2 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ilang taon nag-aral sa Europa si Crisostomo Ibarra?",
                options: ["5 taon", "7 taon", "8 taon"],
                answer: "7 taon"
            },
            {
                question: "Saang bansa natutunan ni Ibarra ang pakikipagkamay?",
                options: ["Alemanya", "Berlin", "Dresden"],
                answer: "Alemanya"
            },
            {
                question: "Siya ang nagyaya kay Ibarra na mananghalian bukas.",
                options: ["Kapitan Tinong", "Kapitan Tiyago", "Tinyente"],
                answer: "Kapitan Tinong"
            },
            {
                question: "Ang kasing kahulugan ng salitang  nasipagbansag ay __?",
                options: ["Nagpakilala", "Nagsitakbuhan", "Nakipag away"],
                answer: "Nagpakilala"
            },
            {
                question: "Ang kasing kahulugan ng salitang nagulumihanan ay ___?",
                options: ["Naguluhan", "Nahimasmasan", "Nalulungkot"],
                answer: "Naguluhan"
            }
        ];
