...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 17 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sinunggaban",
                options: ["Dinakma o Inagaw", "Inatake", "Sinugod"],
                answer: "Dinakma o Inagaw"
            },
            {
                question: "Bulo",
                options: ["Anak ng aso", "Anak ng kabayo", "Anak ng kalabaw o baka"],
                answer: "Anak ng kalabaw o baka"
            },
            {
                question: "Ampahilom",
                options: ["Anak ng kalabaw o baka", "Gamit para gumaling sa pagkahilo", "Gamit para sa paggaling ng sugat"],
                answer: "Gamit para sa paggaling ng sugat"
            },
            {
                question: "Punglo",
                options: ["Bala", "Buto", "Pala"],
                answer: "Bala"
            },
            {
                question: "Ikinabuwal",
                options: ["Nahuli", "Napahamak", "Natumba"],
                answer: "Natumba"
            }
        ];
