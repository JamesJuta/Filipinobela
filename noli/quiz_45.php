...
<head>
    ...
    <title>Kabanata 45 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 45 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sa isang yungib sa kagubatan ay natagpuan din sa wakas ni Elias si __.",
                options: ["Kapitan Pablo", "Kapitan Tinong", "Kapitan Tiyago "],
                answer: "Kapitan Pablo"
            },
            {
                question: "Ano ang naging dahilan ng Kapitan kung bakit hindi nito nais na sumama kay Elias sa lupain ng mga katutubo?",
                options: ["Dahil sa maiiwang alaala", "Dahil sa mga taong kanyang nakakasama", "Dahil sa paghahanap ng katarungan sa sinapit ng kanyang pamilya"],
                answer: "Dahil sa paghahanap ng katarungan sa sinapit ng kanyang pamilya"
            },
            {
                question: "Ano ang sinapit ng anak na dalaga anak ni Kapitan Pablo sa kamay ng mga kura?",
                options: ["Hinalay ang dalaga", "Nagkaroon ng hindi pagkaka-unawaan ang dalawa", "Pinaghinalaan ang dalaga na magnanakaw"],
                answer: "Hinalay ang dalaga"
            },
            {
                question: "Ano ang nais maisagawa ni Kapitan Pablo kasama ang mga pinag-uusig?",
                options: ["Pagdaramdam", "Paghihiganti", "Pagpoprotesta"],
                answer: "Paghihiganti"
            },
            {
                question: "Sino ang nais isama ni Elias at Kapitan Pablo sa layunin na paghihiganti?",
                options: ["Kapitan Heneral", "Ibarra", "Isagani"],
                answer: "Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_45.php"; // Replace with the actual href link
