...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 14 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Isa siyang Don na matalino kung mag isip.",
                options: ["Don Anastacio", "Don Filipo", "Don Rafael"],
                answer: "Don Anastacio"
            },
            {
                question: "Ang Unibersidad kung saan nag aral si Pilosopo Tasyo.",
                options: ["San Diego", "San Jose", "San Juan"],
                answer: "San Jose"
            },
            {
                question: "Ano ang gusto ng ina para kay Piliposo Tasyo noon?",
                options: ["Guro", "Pari", "Sundalo"],
                answer: "Pari"
            },
            {
                question: "Ang kasing kahulugan ng salitang dagok ay ___?",
                options: ["Malaking kasawian", "Malaking pagkakaiba", "Malaking problema"],
                answer: "Malaking kasawian"
            },
            {
                question: "Ang kasing kahulugan ng salitang lintik ay ___?",
                options: ["Kidlat", "Latigo", "Pinitik"],
                answer: "Kidlat"
            }
        ];
