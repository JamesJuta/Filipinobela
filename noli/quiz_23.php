...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 23 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Bakit napalipat ng bangka ng mga kababaihan ang mga kalalakihan?",
                options: ["Nabighani sila sa ganda ng mga kababaihan", "Nabutas ang bangka", "Naipit sa mabatong parte"],
                answer: "Nabutas ang bangka"
            },
            {
                question: "Ano ang ginawa ni Maria Clara upang hindi mainip ang mga tao?",
                options: ["Kumain", "Kumanta", "Nagkwento"],
                answer: "Kumanta"
            },
            {
                question: "Sino ang nagsasagwan ng kanilang bangka?",
                options: ["Alipin", "Elias", "Fidel"],
                answer: "Elias"
            },
            {
                question: "Ano ang nangyari ng mangisda ang mga kalalakihan?",
                options: ["Malakas ang alon", "May sumulpot na buwaya", "Nasira ang harang"],
                answer: "May sumulpot na buwaya"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang katipan?",
                options: ["Bibliyang libro", "Kasintahan", "Tinapay"],
                answer: "Kasintahan"
            }
        ];
