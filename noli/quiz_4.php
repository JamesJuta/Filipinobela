...
<head>
    ...
    <title>Kabanata 4 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 4 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan nakarating si Ibarra at napansin nito na walang pagbabago sa kanyang lugar?",
                options: ["Sa plasa ng Binondo", "Sa plasa ng Bulacan", "Sa plasa ng Calamba"],
                answer: "Sa plasa ng Binondo"
            },
            {
                question: "Sino ang ama ng binata na pinakamayaman sa bayan ng San Diego?",
                options: ["Don Alidon", "Don Felix", "Don Rafael"],
                answer: "Don Rafael"
            },
            {
                question: "Sino ang nag-iisang tao na naging kakampi ni Don Rafael?",
                options: ["Alferez", "Tinyente Guevarra", "Tulisan"],
                answer: "Tulisan"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang dalamhati ay ___?",
                options: ["Galit", "Hapis", "Kasiyahan"],
                answer: "Hapis"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang masalimuot ay ___?",
                options: ["Magulo", "Malungkot", "Masaya"],
                answer: "Magulo"
            }
        ];
