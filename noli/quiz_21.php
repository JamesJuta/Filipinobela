...
<head>
    ...
    <title>Kabanata 21 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 21 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang dahilan bakit  kumaripas ng takbo si Sisa pauwi sa kanilang bahay?",
                options: ["Dahil lumayas ang kanyang mga anak", "Dahil nagwawala ang kaniyang asawa at nadadamay ang kanyang mga anak", "Dahil nahuli na ng mga gwardiya sibil ang kanyang mga anak"],
                answer: "Dahil nahuli na ng mga gwardiya sibil ang kanyang mga anak"
            },
            {
                question: "Ano ang ginawa ng mga gwardiya sibil kay Sisa papuntang kwartel?",
                options: ["Binuhusan ng tubig", "Kinaladkad", "Pinapalo"],
                answer: "Kinaladkad"
            },
            {
                question: "Ano ang natagpuan ni Sisa ng ito ay makauwi sa kanilang bahay?",
                options: ["Bangkay ni Crispin", "Magulong bahay nila", "Punit at duguang damit ni Basilyo"],
                answer: "Punit at duguang damit ni Basilyo"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang pilas?",
                options: ["Kutob", "Nahuli", "Punit"],
                answer: "Punit"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang kuwartel?",
                options: ["Gusali ng mga sundalo", "Kumpisalan", "Motel"],
                answer: "Gusali ng mga sundalo"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_21.php"; // Replace with the actual href link
