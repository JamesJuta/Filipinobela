...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 33 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang palihim na dumating sa bahay ni Ibarra at sila’y nagusap tungkol sa mga kaaway ng katipan ni Maria?",
                options: ["Elias", "Kapitan Tiyago", "Solomon"],
                answer: "Elias"
            },
            {
                question: "Sino ang lihim na sinusubaybayan ni Elias?",
                options: ["Padre Damaso", "Padre Salvi", "Taong Dilaw"],
                answer: "Taong Dilaw"
            },
            {
                question: "Kanino nagkainteres si Ibarra dahil sa kanyang mga kaisipan na kakaiba?",
                options: ["Elias", "Klay", "Pilosopo Tasyo"],
                answer: "Elias"
            },
            {
                question: "Ang kasing kahulugan ng salitang binalaan ay ___?",
                options: ["Binantaan", "Kinompronta", "Sinigawan"],
                answer: "Binantaan"
            },
            {
                question: "Ang kasing kahulugan ng salitang namanhik ay ___?",
                options: ["Nahirapan", "Nanghusga", "Nanligaw"],
                answer: "Nanligaw"
            }
        ];
