...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 39 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Siya ang asawa ng Alperes na nagpipilit na maging mukang taga-Europa.",
                options: ["Donya Consolacion", "Donya Maria", "Donya Victorina"],
                answer: "Donya Consolacion"
            },
            {
                question: "Ano ang dating hanapbuhay ni Donya Consolacion bago niya napangasawa ang Alperes?",
                options: ["Labandera", "Mangangalakal", "Mag-aalahas"],
                answer: "Labandera"
            },
            {
                question: "Sino ang nilatigo ni Donya Consolacion dahil nito sinusunod ang utos nito na kumanta?",
                options: ["Basilio", "Elias", "Sisa"],
                answer: "Sisa"
            },
            {
                question: "Ano ang nadatnan ng Alperes sa nangyayari kay Sisa?",
                options: ["Nagtatago sa karwahe", "Nagwawala sa kalye", "Nahubaran at nagdurugo ang sugat"],
                answer: "Nahubaran at nagdurugo ang sugat"
            },
            {
                question: "Kanino nakatakdang ihatid si Sisa?",
                options: ["Basilio", "Donya Maria", "Ibarra"],
                answer: "Ibarra"
            }
        ];
