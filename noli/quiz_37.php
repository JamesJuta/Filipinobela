...
<head>
    ...
    <title>Kabanata 37 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 37 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang taong humahanap kay Ibarra dahil sa ginawa nito sa kura?",
                options: ["Don Filipo", "Kapitan Heneral", "Kapitan Tiyago"],
                answer: "Kapitan Heneral"
            },
            {
                question: "Tanda ito ng mabuting ugali ng Kapitan Heneral na mayroong panahon basta sa __.",
                options: ["Kabutihan", "Kagalakan", "Katarungan "],
                answer: "Katarungan "
            },
            {
                question: "Siya ang nais kausapin ng Kapitan Heneral bago ito pumunta ng Espanya.",
                options: ["Ibarra", "Diego", "Maria Clara"],
                answer: "Maria Clara"
            },
            {
                question: "Saang bansa ang hindi babagay ang katalinuhan na mayroon si Ibarra?",
                options: ["Amerika", "Espanya", "Pilipinas"],
                answer: "Pilipinas"
            },
            {
                question: "Sino ang sinabihan ng Heneral na protektahan ang binata na si Ibarra na maisakatuparan nito ang layunin?",
                options: ["Alkalde Mayor", "Maria Clara", "Kapitan Tiyago"],
                answer: "Maria Clara"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_37.php"; // Replace with the actual href link
