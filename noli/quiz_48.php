...
<head>
    ...
    <title>Kabanata 48 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 48 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Kanino ipinabasa ni Ibarra ang sulat na tinanggal na ang kaniyang pagiging ekskomulgado?",
                options: ["Kapitan Tiyago", "Maria Clara", "Tiya Isabel"],
                answer: "Tiya Isabel"
            },
            {
                question: "Saan nakita ni Ibarra si Maria Clara at Linares?",
                options: ["Bahay ni Kapitan Tinong", "Balkon ng bahay ni Kapitan Tiyago", "Ilog Asotea"],
                answer: "Ilog Asotea"
            },
            {
                question: "Sino ang nagpahowatig na hindi mahalaga ang pagiging ekskomulgado ni Ibarra sapagkat sila ay ekskomulgado rin?",
                options: ["Elias", "Linares", "Nol Juan"],
                answer: "Nol Juan"
            },
            {
                question: "Ano ang iniutos ni Ibarra kay Nol Juan?",
                options: ["Ang ayusin ang itinatayong paaralan", "Ang papuntahin si Elias", "Ang talaan ng obrero"],
                answer: "Ang talaan ng obrero"
            },
            {
                question: "Ano ang nakita ni Ibarra sa Talaan ng Obrero?",
                options: ["Napunit ang pahina ng talaan", "Naroon ang pangalan ng mga Prayle", "Wala roon ang pangalan ni Elias"],
                answer: "Wala roon ang pangalan ni Elias"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_48.php"; // Replace with the actual href link
