...
<head>
    ...
    <title>Kabanata 9 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 9 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Bakit takot si Kapitan Tiyago kay Padre Damaso maliban sa pagiging pari nito?",
                options: ["Dahil kamag-anak ito ng pamilya ni Kapitan Tiyago", "Dahil pangalawang ama ito ni Maria Clara", "Dahil sadyang matapang lang si Padre Damaso"],
                answer: "Dahil pangalawang ama ito ni Maria Clara"
            },
            {
                question: "Bakit pinatay kaagad ni Padre Damaso ang kandila?",
                options: ["Dahil baka maging sanhi ito ng sunog", "Para maging hindi ligtas si Ibarra sa kapahamakan", "Upang maging ligtas si Ibarra sa kapahamakan"],
                answer: "Para maging hindi ligtas si Ibarra sa kapahamakan"
            },
            {
                question: "Saang kumbento nagtungo si Padre Sibyla?",
                options: ["Dominikano sa Puerta de Isabel II", "Dominikano sa Puerta de Isabel IV", "Dominikano sa Puerta de Isabel VI"],
                answer: "Dominikano sa Puerta de Isabel II"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang hidwaan?",
                options: ["Alitan", "Kaaway", "Usapan"],
                answer: "Alitan"
            },
            {
                question: "Ano ang kasing kahulugan ng salitang yayat?",
                options: ["Makapal", "Manipis", "Sasakyan"],
                answer: "Manipis"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_9.php"; // Replace with the actual href link
