...
<head>
    ...
    <title>Kabanata 50 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 50 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang ibinahagi ni Elias kay Ibarra?",
                options: ["Ang kanyang kasarinlan", "Ang kanyang layunin", "Ang kanyang pinagmulan"],
                answer: "Ang kanyang pinagmulan"
            },
            {
                question: "Mayroon nang animnapung taon ang nakalipas ng ang kaniyang nuno ay naging isang Tenedor De Libros sa isang bahay-kalakal ng anong lahi?",
                options: ["Amerikano", "Hapon", "Kastila"],
                answer: "Kastila"
            },
            {
                question: "Ano ang isinakdal sa nuno ni Elias ng tanggapan na kaniyang pinaglilingkuran?",
                options: ["Pagnanakaw", "Pagtataksil", "Panununog"],
                answer: "Panununog"
            },
            {
                question: "Ano ang dahilan ng pagkamatay ng nuno ni Elias?",
                options: ["Pagbigti", "Pagkagutom", "Pagkakasakit"],
                answer: "Pagbigti"
            },
            {
                question: "Saang kuta bumalik si Elias upang sumama sa pakikibaka sa mga Kastila?",
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_50.php"; // Replace with the actual href link
