...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 30 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Magkano ang halaga ng pagdaraos ng misa?",
                options: ["Dalwang daan at animnapung piso", "Dalawang daan at limampung piso", "Tatlong daan at animnapung piso"],
                answer: "Dalawang daan at limampung piso"
            },
            {
                question: "Ayon sa nakararami mainam na magbayad ng mahal sa misa kumapara sa ___?",
                options: ["Komedya", "Palaro", "Pelikula"],
                answer: "Komedya"
            },
            {
                question: "Siya ang nagmisa sa araw ng Kapistahan.",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Hindi nila sinisimulan ang misa hanggat wala ang ___?",
                options: ["Alkade Mayor", "Pari", "Santo"],
                answer: "Alkade Mayor"
            },
            {
                question: "Sino ang paring siniraan ni Padre Damaso matapos nito magmisa?",
                options: ["Padre Manuel", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Manuel"
            }
        ];
