...
<head>
    ...
    <title>Kabanata 44 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 44 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang nilalagnat?",
                options: ["Andeng", "Iday", "Maria Clara"],
                answer: "Maria Clara"
            },
            {
                question: "Dahil sa pagkapikon ay iminungkahi ni Donya Victorina na gamutin ng kanyang kumpisal ang nakababanas na si __.",
                options: ["Alperes", "Donya Consolacion", "Don Tiburcio"],
                answer: "Donya Consolacion"
            },
            {
                question: "Sino ang dumating upang ihanda si Maria sa kumpisal at upang makalimot na rin kay Ibarra?",
                options: ["Donya Alba", "Donya Victorina", "Tiya Isabel"],
                answer: "Tiya Isabel"
            },
            {
                question: "Ano ang kahulugan ng Tagatak?",
                options: ["Basa", "Hinampas", "Tinaga"],
                answer: "Basa"
            },
            {
                question: "Ano ang kahulugan ng Terasa?",
                options: ["Balkonahes", "Salas", "Trangkahan"],
                answer: "Balkonahes"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_44.php"; // Replace with the actual href link
