...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 19 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sa tabi ng lawa ay nagkita sina _____ at ang guro sa San Diego.",
                options: ["Maria Clara", "Ibarra", "Kapitan Tiyago"],
                answer: "Ibarra"
            },
            {
                question: "Isa diumano si _____ sa iilang nakipag-libing sa kanyang ama.",
                options: ["Tinyente Guevarra", "Don Rafael", "Don Tiburcio"],
                answer: "Tinyente Guevarra"
            },
            {
                question: "Sino ang tumulong sa pagbibigay ng pangangailangan ng mga guro noon?",
                options: ["Ama ni Ibarra", "Ina ni Ibarra", "Tito ni Ibarra"],
                answer: "Ama ni Ibarra"
            },
            {
                question: "Ang kasing kahulugan ng salitang unos ay ___?",
                options: ["Kalamidad", "Laro", "Numero"],
                answer: "Kalamidad"
            },
            {
                question: "Ang kasing kahulugan ng salitang pasukab ay ___?",
                options: ["Paghamak", "Pakutya", "Sukat"],
                answer: "Pakutya"
            }
        ];
