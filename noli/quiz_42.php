...
<head>
    ...
    <title>Kabanata 42 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 42 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang pinsan ni Kapitan Tiyago?",
                options: ["Don Tiburcio", "Tiya Coring", "Tiya Isabel"],
                answer: "Tiya Isabel"
            },
            {
                question: "Ito ang doctor na nilapitan ni Kapitan Tiyago.",
                options: ["Don Ibarra", "Don Manuel", "Don Tiburcio"],
                answer: "Don Tiburcio"
            },
            {
                question: "Sino ang pinakilala ni Donya Victorina kay Kapitan Tiyago?",
                options: ["Espejo", "Juan", "Linares"],
                answer: "Linares"
            },
            {
                question: "Ito ang asawa ni Don Tiburcio.",
                options: ["Donya Alba", "Donya Consolacion", "Donya Victorina"],
                answer: "Donya Victorina"
            },
            {
                question: "Ano ang kahulugan ng Agua de Colonia?",
                options: ["Banal na Tubig", "Inumin na Tsaa", "Pabango"],
                answer: "Pabango"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_42.php"; // Replace with the actual href link
