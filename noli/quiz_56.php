...
<head>
    ...
    <title>Kabanata 56 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 56 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sa buong bayan ng ___ ay sakmal pa rin ang takot ng kinabukasan, walang makitang taong naglalakas sa gitna ng daan.",
                options: ["San Diego", "San Pablo", "San Simon"],
                answer: "San Diego"
            },
            {
                question: "Sino ang Heneral na nakausap ng isang lalaki na kagagaling lamang sa tribunal?",
                options: ["Hermana Penchang", "Hermana Pute", "Hermana Sol"],
                answer: "Hermana Pute"
            },
            {
                question: "Sino ang sumunog sa bahay ng Binatang si Ibarra dahil sa mga kuro-kuro na naipamalita sa kanilang lugar?",
                options: ["Kastila", "Prayle", "Sibil"],
                answer: "Sibil"
            },
            {
                question: "May isang babae na nakakita sa isang puno ng santol na nakabitin ang katawan ni ___.",
                options: ["Bruno", "Lucas", "Pedro"],
                answer: "Lucas"
            },
            {
                question: "Sino ang dalawang nasa loob ng bahay na nakaligtas diumano sa paghihiganti ni Ibarra sa simbahan?",
                options: ["Padre Damaso at Kapitan Tinong", "Padre Salvi at Kapitan Tiyago", "Padre Sibyla at Kapitan-Heneral"],
                answer: "Padre Salvi at Kapitan Tiyago"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_56.php"; // Replace with the actual href link
