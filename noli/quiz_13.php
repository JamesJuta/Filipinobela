...
<head>
    ...
    <title>Kabanata 13 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 13 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Bakit nagtungo si Ibarra sa sementeryo?",
                options: ["Upang bisitahin ang puntod ng kanyang mga katulong", "Upang hanapin ang puntod ng kanyang ama", "Upang kamustahin ang puntod ng kanyang ina"],
                answer: "Upang hanapin ang puntod ng kanyang ama"
            },
            {
                question: "Ano ang dahilan sa pagkasindak ni Ibarra sa pagtatapat ng sepulturero?",
                options: ["Binenta ang bangkay", "Inilipat ang bangkay", "Itinapon ang bangkay"],
                answer: "Itinapon ang bangkay"
            },
            {
                question: "Kanino humingi ng paliwanag si Ibarra patungkol sa nangyari sa bangkay ng kanyang ama?",
                options: ["Alperez", "Kapitan Tiyago", "Padre Salvi"],
                answer: "Padre Salvi"
            },
            {
                question: "Ang kasing kahulugan ng salitang binagtas ay ___?",
                options: ["Binugbog", "Dinaanan", "Sinalubong"],
                answer: "Dinaanan"
            },
            {
                question: "Ang kasing kahulugan ng salitang tinalunton ay ___?",
                options: ["Hinalughog", "Pinahuli", "Sinundan"],
                answer: "Sinundan"
            }
        ];
