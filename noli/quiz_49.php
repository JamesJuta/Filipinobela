...
<head>
    ...
    <title>Kabanata 49 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 49 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sino ang naging sugo ng sawimpalad?",
                options: ["Elias", "Ibarra", "Lucas"],
                answer: "Elias"
            },
            {
                question: "Sino ang nais makausap ni Ibarra ngunit ito’y kanyang inatrasan sa pangangambang baka makita nito si Elias?",
                options: ["Alperes", "Don Tiyago", "Padre Damaso"],
                answer: "Alperes"
            },
            {
                question: "Sino ang pinuno ng mga tulisan na Samahan ng mga Sawimpalad?",
                options: ["Kapitan Pablo", "Kapitan Tiburcio", "Kapitan Tinong"],
                answer: "Kapitan Pablo"
            },
            {
                question: "Saan humihingi ng tulong si Ibarra upang maisakatuparan ang kaniyang mga binabalak?",
                options: ["Kaibigan sa Madrid", "Kamag-anak sa Madrid", "Pamilya sa Madrid"],
                answer: "Kaibigan sa Madrid"
            },
            {
                question: "Sa huli ay hindi napapayag ni Elias si Ibarra sa kaniyang pakiusap kung kaya’t sinabi nito na sabihin nya sa mga sawimpalad na umasa na lamang sa ___.",
                options: ["Diyos", "Pamahalaan", "Sarili"],
                answer: "Diyos"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_49.php"; // Replace with the actual href link
