...
<head>
    ...
    <title>Kabanata 43 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 43 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Sa kabila ng magaspang nap ag-uugali ni Padre Damaso ay marunong pala itong umiyak at malambot din ang kalooban, at ito ay nakita nila sa pag-aalala kay __?",
                options: ["Donya Victorina", "Maria Clara", "Tiya Isabel"],
                answer: "Maria Clara"
            },
            {
                question: "Bakit ipinakilala ni Donya Victorina si Linares kay Maria Clara?",
                options: ["Upang maging magkaibigan ang dalawa", "Upang magsama sa negosyo", "Upang maging magkasintahan ang dalawa"],
                answer: "Upang maging magkasintahan ang dalawa"
            },
            {
                question: "Ano ang tinapos ni Linares sa Universidad Central?",
                options: ["Abogado", "Doktor", "Guro"],
                answer: "Abogado"
            },
            {
                question: "Sino ang sumangguni kay Padre Salvi upang alamin ang nararapat na katarungan para sa kanyang kapatid?",
                options: ["Basilio", "Isagani", "Lucas"],
                answer: "Lucas"
            },
            {
                question: "Magkano ang hinihinging halaga ni Lucas kay Padre Salvi kapalit ang buhay ng kanyang kapatid?",
                options: ["Apat na daang piso", "Limang-daang piso", "Tatlong-daang piso"],
                answer: "Limang-daang piso"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_43.php"; // Replace with the actual href link
