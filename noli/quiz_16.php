...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 16 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Siya ang ina ng dalawang batang sakristan?",
                options: ["Andeng", "Consolacion", "Sisa"],
                answer: "Sisa"
            },
            {
                question: "Kanino galing ang mga putahe na inihanda ni Sisa para sa kanyang mga anak?",
                options: ["Ibarra", "Padre Salvi", "Pilosopo Tasyo"],
                answer: "Pilosopo Tasyo"
            },
            {
                question: "Ang kasing kahulugan ng salitang kapritso ay ___?",
                options: ["Gusto", "Kapiraso", "Luho"],
                answer: "Luho"
            },
            {
                question: "Ang kasing kahulugan ng salitang namumurok ay ___?",
                options: ["Nagpapalay", "Nakakasakit", "Nananaba"],
                answer: "Nananaba"
            },
            {
                question: "Ang kasing kahulugan ng salitang pobre ay ___?",
                options: ["Mahirap", "Mataray", "Mayaman"],
                answer: "Mahirap"
            }
        ];
