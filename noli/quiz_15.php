...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 15 - Noli Me Tangere</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Inalo",
                options: ["Inalagaan", "Inaruga", "Pinagsilbihan"],
                answer: "Inaruga"
            },
            {
                question: "Kalumbayan",
                options: ["Kalungkutan", "Kapuutan", "Kasiyahan"],
                answer: "Kalungkutan"
            },
            {
                question: "Hiyaw",
                options: ["Nasaktan", "Sigaw", "Umiyak"],
                answer: "Sigaw"
            },
            {
                question: "Tinutulan",
                options: ["Hindi pinayagan", "Hindi sinang-ayunan", "Pinutulan"],
                answer: "Hindi sinang-ayunan"
            },
            {
                question: "Panaghoy",
                options: ["Gamit sa pagsulat", "Pagkain", "Pag-daing"],
                answer: "Pag-daing"
            }
        ];
