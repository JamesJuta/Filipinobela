...
<head>
    ...
    <title>Kabanata 62 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 62 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang nakaagaw ng atensyon ni Maria Clara?",
                options: ["Ang balitang namatay at nalunod si Ibarra", "Ang pagdating ni Padre Damaso", "Ang pagsira ng kasunduan sa kasal"],
                answer: "Ang balitang namatay at nalunod si Ibarra"
            },
            {
                question: "Sino ang humuling na sirain ang kasunduan na pagpapakasal ni Maria Clara kay Linares?",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Ano ang higit na pinili ni Padre Damaso na gawin ni Maria Clara sa kanyang buhay?",
                options: ["Pagkamatay", "Pagpasok sa kumbento", "Pagpapakasal kay Linares"],
                answer: "Pagpasok sa kumbento"
            },
            {
                question: "Sino ang nais pakasalan ni Maria Clara?",
                options: ["Elias", "Ibarra", "Linares"],
                answer: "Ibarra"
            },
            {
                question: "Ano ang dalawang bagay na ginawa ni Maria Clara nang malaman na patay na si Maria Clara?",
                options: ["Kumbento at Kamatayan", "Kumbento at Pakasal", "Kamatayan at Hanapin si Ibarra "],
                answer: "Kumbento at Kamatayan"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_62.php"; // Replace with the actual href link
