...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Buod - Noli Me Tangere</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: IAYOS ANG MGA SALITA AYON SA TINDI NG KAHULUGAN.</h2><br>
    ...
    <script>
        const questions = [
            {
                question: "Siya ang naglahad kay Ibarra sa sinapit ng kanyang ama noong ito’y hindi nya nakakasama.",
                options: ["Kapitan Tiyago", "Pilosopo Tasyo", "Tinyente Guevarra"],
                answer: "Tinyente Guevarra"
            },
            {
                question: "Ang paring nagparatang kay Don Rafael Ibarra na isa siyang Erehe at Pilibustero.",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Siya ang pumigil kay Ibarra sa pagtangkang pagsaksak kay Padre Damaso.",
                options: ["Elias", "Kapitan-Heneral", "Maria Clara"],
                answer: "Maria Clara"
            },
            {
                question: "Siya ang tumulong kay Ibarra na mapawalang bisa ang pagka-eskomulgado ni Ibarra.",
                options: ["Maira Clara", "Kapitan-Heneral", "Sisa"],
                answer: "Kapitan-Heneral"
            },
            {
                question: "Sino ang binatang kastila na ipapakasal kay Maria Clara?",
                options: ["Alperes", "Linares", "Nol Juan"],
                answer: "Linares"
            },
            {
                question: "Siya ang tumulong kay Ibarra na ipagpatuloy ang naudlot na pagpapatayo ng paaralan.",
                options: ["Alperes", "Linares", "Nol Juan"],
                answer: "Nol Juan"
            },
            {
                question: "Siya ang nagliligtas at nag-alay ng kanyang buhay kay Ibarra.",
                options: ["Elias", "Kapitan-Heneral", "Maira Clara"],
                answer: "Elias"
            },
            {
                question: "Dahil sa labis na pangungulila ni Maria Clara kay Ibarra, ano ang hiniling ni Maria Clara kay Padre Damaso?",
                options: ["Pumasok sa Kumbento", "Pumasok sa Paaralan", "Pumasok sa Tanggapan ng Heneral"],
                answer: "Pumasok sa Kumbento"
            },
            {
                question: "Sino ang tunay na ama ni Maria Clara?",
                options: ["Padre Damaso", "Padre Salvi", "Padre Sibyla"],
                answer: "Padre Damaso"
            },
            {
                question: "Siya ang kasama ni Elias na mamatay sa maalamat na gubat.",
                options: ["Crispin", "Linares", "Sisa"],
                answer: "Sisa"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "buod.php"; // Replace with the actual href link
