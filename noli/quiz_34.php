...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 34 - Noli Me Tangere</u></center></h1>
        </div>
        ...
        const questions = [
            {
                ...
                options: ["Heneral", "Ibarra", "Padre Damaso"],
                answer: "Heneral"
            },
            {
                question: "Bakit nagtataka ang mga bisita habang sila ay kumakain?",
                options: ["Dahil hindi nila makita si Padre Salvi", "Dahil nagkaroon ng sagutan ang dalawang mga Don", "Dahil wala pa si Padre Damaso"],
                answer: "Dahil wala pa si Padre Damaso"
            },
            {
                question: "Siya ang hindi bumati kay Padre Damaso ng ito ay dumating.",
                options: ["Elias", "Ibarra", "Padre Salvi"],
                answer: "Ibarra"
            },
            {
                question: "Sino ang sisingit sana sa usapan upang mabago ang pinaguusapan dahil sa patutsada ni Padre Damaso kay Ibarra?",
                options: ["Alkade", "Kapitan Tiyago", "Maria Clara"],
                answer: "Alkade"
            },
            {
                question: "Siya ang pumigil kay Ibarra upang makapagpigil ito.",
