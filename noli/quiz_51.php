...
<head>
    ...
    <title>Kabanata 51 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 51 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ano ang natanggap ni Linares mula kay Donya Victorina na nakapagbalisa dito?",
                options: ["Alahas", "Liham", "Rebolber"],
                answer: "Liham"
            },
            {
                question: "Sino ang nagbalita tungkol sa sulat na padala ng arsobispo tungkol sa ekskomunsyon kay Ibarra?",
                options: ["Padre Salvi", "Kapitan Tiyago", "Donya Victorina"],
                answer: "Padre Salvi"
            },
            {
                question: "Sino ang nakarinig ng usapan ni Padre Salvi at Kapitan Tiyago ukol sa liham para kay Ibarra?",
                options: ["Donya Victorina", "Linares", "Maria Clara"],
                answer: "Maria Clara"
            },
            {
                question: "Sino ang naging daan nina Maria Clara at Ibarra para masabi ang kanilang saloobin?",
                options: ["Elias", "Sinang", "Victoria"],
                answer: "Victoria"
            },
            {
                question: "Sino ang sising-sisi sa pagiging hambog at sinungaling mahangad lamang na makapagsamantala?",
                options: ["Linares", "Lucas", "Padre Salvi"],
                answer: "Linares"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_51.php"; // Replace with the actual href link
