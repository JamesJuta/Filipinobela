...
<head>
    ...
    <title>Kabanata 52 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 52 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan ipapadala ni Ibarra ang asawa ng isang anino upang doon ay ipagamot?",
                options: ["Laguna", "Mandaluyong", "Maynila"],
                answer: "Maynila"
            },
            {
                question: "Noon din ay sinabi ng alila ni Ibarra na sila ay marami na at aabot ang kanilang bilang sa __ katao.",
                options: ["Dalawampu", "Sampu", "Tatlumpu"],
                answer: "Dalawampu"
            },
            {
                question: "Ano ang isinigaw ng mga tao na kasamahan ng mga anino ng makita nila si Ibarra?",
                options: ["“Mabuhay Don Crisostomo”", "“Mabuhay Don Ibarra”", "“Mabuhay”"],
                answer: "“Mabuhay Don Crisostomo”"
            },
            {
                question: "Sino ang dalawang nagsugal sa ibabaw ng puntod ng mga patay?",
                options: ["Elias at Lucas", "Ibarra at Elias", "Lucas at Ibarra"],
                answer: "Elias at Lucas"
            },
            {
                question: "Sino ang nanalo sa sugal at naian upang makipagsugal naman sa mga patay?",
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_52.php"; // Replace with the actual href link
