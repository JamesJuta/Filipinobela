...
<head>
    ...
    <title>Kabanata 54 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 54 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Kanino lumapit ang kura upang humingi ng tulong sa pag-aalsa?",
                options: ["Alperes", "Gabinete", "Pamahalaan"],
                answer: "Alperes"
            },
            {
                question: "Nagkasundo ang kura na paghandaan ang gagawin paglusob ng mga ___.",
                options: ["Indios", "Insurektos", "Kastila"],
                answer: "Kastila"
            },
            {
                question: "Sino ang lalaking humahangos sa daan patungo kay Ibarra upang ipagtapat ang nangyayari na pag-aalsa?",
                options: ["Elias", "Sinang", "Maria Clara"],
                answer: "Elias"
            },
            {
                question: "Sino ang lalaking natagpuan ni Elias na lumikha ng matinding kasawian sa kanilang buhay?",
                options: ["Don Fernando", "Don Pedro", "Don Tiburcio"],
                answer: "Don Pedro"
            },
            {
                question: "Sino ang nais saksakin ni Elias gamit ang balaraw ng matuklasan niya ang nuno na pinagmulan nito?",
                options: ["Don Pedro", "Ibarra", "Maria Clara"],
                answer: "Ibarra"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_54.php"; // Replace with the actual href link
