...
<head>
    ...
    <title>Kabanata 53 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 53 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Ilan ang kandilang sinindihan sa paniniwala ng mga kapatiran ni San Francisco?",
                options: ["Dalawampu", "Sampu", "Tatlumpu"],
                answer: "Sampu"
            },
            {
                question: "Nabanggit ni Don ___ ang pagtanggap diumano ng Alkalde sa kanyang pagbibitiw sa tungkulin.",
                options: ["Don Filipo", "Don Pedro", "Don Simon"],
                answer: "Don Filipo"
            },
            {
                question: "Ipinahayag ng Pilosopo na ang mga kabataan na nag-aral sa ___ ay nagkakaroon ng malawak na kaalaman tungkol sa kasaysayan, Matematika, Agham, Wika at iba pa.",
                options: ["Amerika", "Asya", "Europa"],
                answer: "Europa"
            },
            {
                question: "Ipinakiusap ni Don Filipo na makipagkita sa kanya si ___ dahil malapit na daw siyang mamatay.",
                options: ["Elias", "Ibarra", "Maria Clara"],
                answer: "Ibarra"
            },
            {
                question: "Sa kabila ng mga sakit na nararamdaman ni Don Filipino ay tumatahak pa rin sa kanya ang ___.",
                options: ["Ang balak ni Pilosopo Tasyo", "Buhay ni Ibarra", "Karimlan ng Pilipinas"],
                answer: "Karimlan ng Pilipinas"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_53.php"; // Replace with the actual href link
