...
<head>
    ...
    <title>Kabanata 64 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 64 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan nanirahan si Padre Damaso nang pumasok sa kumbento si Maria Clara?",
                options: ["Cebu", "Laguna", "Maynila"],
                answer: "Maynila"
            },
            {
                question: "Ano ang sanhi ng pagkamatay ni Padre Damaso?",
                options: ["Bangungot", "Pagtalon sa kumbento", "Pinatay ng isang kawal"],
                answer: "Bangungot"
            },
            {
                question: "Sino ang lumimot sa mga santo at santa at inatupag ang paglalaro ng liyempo, sabong at paghithit ng marijuana?",
                options: ["Don Tiburcio", "Donya Victorina", "Kapitan Tiyago"],
                answer: "Kapitan Tiyago"
            },
            {
                question: "Sino ang nagdagdag ng mga kulot sa ulo upang mapagbuti ang pagbabalat-kayo na siya ay taga-Andalucia?",
                 options: ["Don Tiburcio", "Donya Victorina", "Kapitan Tiyago"],
                answer: "Donya Victorina"
            },
            {
                question: "Sino ang hindi na tinatawag na “doctor” para manggamot at nauubos na rin ang ngipin?",
                 options: ["Don Tiburcio", "Donya Victorina", "Kapitan Tiyago"],
                answer: "Don Tiburcio"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_64.php"; // Replace with the actual href link
