...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 8 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saang kalye napadako si Ibarra na naalalang minsan ay nahilo siya sa napakasamang amoy ng tabako doon?",
                options: ["Kalye ng Arroceros", "Kalye ng Azoceros", "Wala sa nabanggit"],
                answer: "Kalye ng Arroceros"
            },
            {
                question: "Ano ang nasabi ni Ibarra nang makita niya ang Maynila?",
                options: ["Maraming magnanakaw", "Puro korapsyon", "Walang pinag-unlad"],
                answer: "Walang pinag-unlad"
            },
            {
                question: "Ang karunungan ay matatamo kapag hinangad ng ____.",
                options: ["Damdamin", "Puso", "Utak"],
                answer: "Puso"
            },
            {
                question: "Ang ______ ay dapat linangin at isalin sa susunod na henerasyon.",
                options: ["Kaalaman", "Karunungan", "Natutunan"],
                answer: "Karunungan"
            },
            {
                question: "Ano ang kasing kahulugan ng napasupling?",
                options: ["Mapalaki", "Mapatubo", "Mapa-usbong"],
                answer: "Mapatubo"
            }
        ];
