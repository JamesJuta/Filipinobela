...
<head>
    ...
    <title>Kabanata 47 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 47 - Noli Me Tangere</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Saan nagtungo ang mag-asawang Donya Victorina at Don Tiburcio?",
                options: ["Sa ginagawang paaralan ni Ibarra", "Sa mga bahay ng mga Indio", "Sa simbahan"],
                answer: "Sa mga bahay ng mga Indio"
            },
            {
                question: "Sino ang kanilang nakita sa bahay ng Alperes?",
                options: ["Donya Consolacion", "Kapitan Tiyago", "Padre Damaso"],
                answer: "Donya Consolacion"
            },
            {
                question: "Sino ang nagkaroon ng alitan sa bahay ng Alperes?",
                options: ["Donya Consolacion at Donya Victorina", "Don Tiburcio at Alperes", "Don Tiburcio at Don Pedro"],
                answer: "Donya Consolacion at Donya Victorina"
            },
            {
                question: "Dahil sa labis na galit ni Donya Victorina sino ang napagbalingan nito?",
                options: ["Elias", "Linares", "Maria Clara"],
                answer: "Linares"
            },
            {
                question: "Magkano ang naging kabayaran ni Kapitan Tiyago kay Don Tiburcio sa pagpapagamot nito kay Maria Clara?",
                options: ["Isang daang piso", "Isang libong piso", "Sampung libong piso"],
                answer: "Isang libong piso"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_47.php"; // Replace with the actual href link
