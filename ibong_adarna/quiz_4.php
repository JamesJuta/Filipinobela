...
<head>
    ...
    <title>Korido 4 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 4 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Kapagdaka",
                options: ["Mabilisan", "Pangamba", "Pagtataka"],
                answer: "Mabilisan"
            },
            {
                question: "Matahak",
                options: ["Maabot", "Mapagod", "Marating"],
                answer: "Marating"
            },
            {
                question: "Pata",
                options: ["Hirap", "Malaman", "Payat"],
                answer: "Hirap"
            },
            {
                question: "Mainam",
                options: ["Mabuti", "Malinamnam", "Pampalakas"],
                answer: "Mabuti"
            },
            {
                question: "Nagulaylay",
                options: ["Napahinga", "Napakain", "Natisod"],
                answer: "Napahinga"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_4.php"; // Replace with the actual href link
