...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 24 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Kalapating BINUSILAK.",
                options: ["Kagandahan", "Malinis", "Pagtatago"],
                answer: "Malinis"
            },
            {
                question: "Ang ginawang PANGUNGUBLI.",
                options: ["Kagandahan", "Malinis", "Pagtatago"],
                answer: "Pagtatago"
            },
            {
                question: "Sa KARIKTANG napagmalas",
                options: ["Kagandahan", "Malinis", "Pagtatago"],
                answer: "Kagandahan"
            },
            {
                question: "Hininga ko ma’y MAPATID.",
                options: ["Malagot", "Pagtatago", "Pigilin"],
                answer: "Malagot"
            },
            {
                question: "Na TIMPIIN ang pag-ibig.",
                options: ["Malagot", "Pagtatago", "Pigilin"],
                answer: "Pigilin"
            }
        ];
