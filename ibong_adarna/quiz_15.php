...
<head>
    ...
    <title>Korido 15 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 15 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Lalo siyang NANGILALAS.",
                options: ["Nabighani", "Nagtaka", "Namangha"],
                answer: "Namangha"
            },
            {
                question: "Ang prinsesang MAALINDOG.",
                options: ["Maganda", "Nakiusap", "Nalungkot"],
                answer: "Maganda"
            },
            {
                question: "Sa prinsipe’y NAMUMUHI.",
                options: ["Pang-alis", "Panlunas", "Pamunas"],
                answer: "Panlunas"
            },
            {
                question: "Si Donya Juana’y NALUMBAY.",
                options: ["Nalungkot", "Natuwa", "Tiniis"],
                answer: "Nalungkot"
            },
            {
                question: "Pag di kita NAILUGMOK.",
                options: ["Nabighani", "Nakiusap", "Natalo"],
                answer: "Natalo"
            }
        ];
