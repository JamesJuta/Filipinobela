...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 26 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Labis na ang KAPANGALAN.",
                options: ["Kapaguran", "Matalo", "Paglinlang"],
                answer: "Kapaguran"
            },
            {
                question: "MAGAHIS ng isnag hamak.",
                options: ["Kapaguran", "Matalo", "Paglinlang"],
                answer: "Matalo"
            },
            {
                question: "Ang panibagp niyang HIBO.",
                options: ["Kapaguran", "Matalo", "Paglinlang"],
                answer: "Paglinlang"
            },
            {
                question: "Kaya di man IPAGBADYA",
                options: ["Ikabalisa", "Ipahayag", "Matalo"],
                answer: "Ipahayag"
            },
            {
                question: "Walang dapat IPANIMDIM.",
                options: ["Ikabalisa", "Ipahayag", "Matalo"],
                answer: "Ikabalisa"
            }
        ];
