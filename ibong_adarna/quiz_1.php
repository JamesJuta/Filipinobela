...
<head>
    ...
    <title>Korido 1 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 1 - Ibong Adarna</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Hakbang na pasaliwa",
                options: ["Gumawa ng mga gawain", "Maling gawain", "Tamang gawain"],
                answer: "Maling gawain"
            },
            {
                question: "Pangamba",
                options: ["Nahihiya", "Nagdadalawang-isip", "Natatakot"],
                answer: "Natatakot"
            },
            {
                question: "Mapalaot",
                options: ["Makabalik", "Makarating", "Mapadpad"],
                answer: "Makarating"
            },
            {
                question: "Dinggin",
                options: ["Alalay", "Balewalain", "Pakinggan"],
                answer: "Pakinggan"
            },
            {
                question: "Liwanagan ",
                options: ["Maintindihan", "Maggunam-gunam", "Maguluhan"],
                answer: "Maintindihan"
            }
        ];
