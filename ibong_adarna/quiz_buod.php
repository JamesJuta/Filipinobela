...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="../css/ibong_adarna_quiz_styles.css">
        
    <!----===== Boxicons CSS ===== -->
    <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
    
    <title>Buod - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Buod - Ibong Adarna</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PILIIN ANG TAMANG KAHULUGAN NG MGA SUMUSUNOD NA PAHAYAG.</h2><br>
        ...
        <div id="question" class="quiz_form"></div>
            <form id="quiz-form" >
                ...
                <div class="button-container">
                    <a href="../ibong_adarna.php" class="back_btn">Bumalik sa Nobela</a>
                </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang kaharian na pinamumunuan ni Haring Fernando?",
                options: ["Amenya", "Babylonia", "Berbanya"],
                answer: "Berbanya"
            },
            {
                question: "Sino ang unang naghanap sa mahiwagang ibon na Adarna?",
                options: ["Don Diego", "Don Juan", "Don Pedro"],
                answer: "Don Pedro"
            },
            {
                question: "Saan hinikayat ng magkapatid na Don Pedro at Don Diego si Don Juan na doon manirahan?",
                options: ["Amenya", "Babylonia", "Berbanya"],
                answer: "Amenya"
            },
            {
                question: "Sino ang nagtagumpay na kuhanin ang mahiwagang Ibong Adarna?",
                options: ["Don Diego", "Don Juan", "Don Pedro"],
                answer: "Don Juan"
            },
            {
                question: "Sino ang nakita ni Don Juan sa bundok ng Tabor at binigyan siya ng dayap at labaha panlaban sa antok dulot ng pagkanta ng ibon?",
                options: ["Don Pedro", "Haring Fernando", "Matandang Ermitanyo"],
                answer: "Matandang Ermitanyo"
            },
            {
                question: "Namangha si Don Juan sa labis na kagandahan ni __ sa loob ng balon",
                options: ["Don Juana", "Donya Maria", "Leonora"],
                answer: "Don Juana"
            },
            {
                question: "Kanino nakasal si Leonora?",
                options: ["Don Diego", "Don Juan", "Don Pedro"],
                answer: "Don Pedro"
            },
            {
                question: "Lumakas ang pangangatawan ni Don Juan sa pamamagitan ng tubig na nagmumula sa Ilog?",
                options: ["Ilog Asotea", "Ilog Bay", "Ilog Jordan"],
                answer: "Ilog Jordan"
            },
            {
                question: "Sino ang gumamit ng Mahika upang mapa-ibig si Don Juan at maisagawa ang pagsubok?",
                options: ["Don Juana", "Donya Maria", "Leonora"],
                answer: "Donya Maria"
            },
            {
                question: "Sino ang nagtapat sa hari ng tunay na ginawa ng magkapatid na Don Pedro at Don Diego?",
                options: ["Don Juana", "Donya Maria", "Leonora"],
                answer: "Leonora"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_buod.php"; // Replace with the actual href link
            ...
            restartButton.style.backgroundColor = "#e18e96";
            ...
            backButton.href = "../ibong_adarna.php"; // Replace with the actual href link
            ...
            backButton.style.backgroundColor = "#de3163";
            ...
            backButton.addEventListener("mouseenter", () => {
                backButton.style.backgroundColor = "#c72c48";
            ...
            restartButton.addEventListener("mouseenter", () => {
                restartButton.style.backgroundColor = "#c08081";
