...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 7 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Tinulinan",
                options: ["Binilisan", "Maalala", "Nagdilim"],
                answer: "Binilisan"
            },
            {
                question: "Dampa",
                options: ["Binilisan", "Maalala", "Munting Bahay"],
                answer: "Munting Bahay"
            },
            {
                question: "Ermitanyo",
                options: ["Taong lumalaban sa mga hayop", "Taong namumuhay nang mag-isa", "Taong naggagamot"],
                answer: "Taong namumuhay nang mag-isa"
            },
            {
                question: "Mahagap",
                options: ["Binilisan", "Maalala", "Nagdilim"],
            ...
            {
                question: "Talinghaga",
                options: ["Binilisan", "Hiwaga", "Maalala"],
                answer: "Hiwaga"
            }
        ];
