...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 10 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Lugong-lugo",
                options: ["Hinang-hina", "Kaawaan", "Magwawakas"],
                answer: "Hinang-hina"
            },
            {
                question: "Tumalaga",
                options: ["Hangad", "Kaawaan", "Umasa"],
                answer: "Umasa"
            },
            {
                question: "Panambitan",
                options: ["Kahilingan", "Magwawakas", "Mapahamak"],
                answer: "Kahilingan"
            },
            {
                question: "Pitang",
                options: ["Hangad", "Nagniningning", "Panawagan"],
                answer: "Hangad"
            },
            {
                question: "Hahangga",
                options: ["Hahantong", "Hangad", "Nagniningning"],
                answer: "Hahantong"
            }
        ];
