...
<head>
    ...
    <title>Korido 9 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 9 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Liyag",
                options: ["Mahal", "Mapahamak", "Marating"],
                answer: "Mahal"
            },
            {
                question: "Nasindak",
                options: ["Labis na pagkatakot", "Mapahamak", "Sumabay"],
                answer: "Labis na pagkatakot"
            },
            {
                question: "Kauukilkil",
                options: ["Apihin", "Katatanong", "Panukala"],
                answer: "Katatanong"
            },
            {
                question: "Mapagsukab",
                options: ["Apihin", "Balak", "Mapagtaksil"],
                answer: "Mapagtaksil"
            },
            {
                question: "Napabulag",
                options: ["Mapagtaksil", "Marating", "Napalinlang"],
                answer: "Napalinlang"
            }
        ];
