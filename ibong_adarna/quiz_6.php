...
<head>
    ...
    <title>Korido 6 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 6 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Tulutan",
                options: ["Mababang-loob", "Nagdadalawang-isip", "Payagan"],
                answer: "Payagan"
            },
            {
                question: "Subyang",
                options: ["Mababang-loob", "Nagdadalawang-isip", "Pasakit"],
                answer: "Pasakit"
            },
            {
                question: "Magtatanan",
                options: ["Magdamdam", "Magsinungaling", "Tatakas"],
                answer: "Tatakas"
            },
            {
                question: "Namanglaw",
                options: ["Magdamdam", "Nakamarka", "Nalungkot"],
                answer: "Nalungkot"
            },
            {
                question: "Nakalimbag",
                options: ["Nakamarka", "Nawawala", "Tinatahak"],
                answer: "Nakamarka"
            }
        ];
