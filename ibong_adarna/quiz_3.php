...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 3 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Nilililo",
                options: ["Masukat", "Pag-aalala", "Pinagtaksilan"],
                answer: "Pinagtaksilan"
            },
            {
                question: "Nahapis",
                options: ["Paghihirap", "Pag-aalala", "Pinagtaksilan"],
                answer: "Paghihirap"
            },
            {
                question: "Bagabag",
                options: ["Balisa", "Diwa", "Panaginip"],
                answer: "Balisa"
            },
            {
                question: "Panagimpan",
