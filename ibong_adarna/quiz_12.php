...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 12 - Ibong Adarna</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PILIIN ANG TAMANG KAHULUGAN NA MAY SALITA NA MAY MALALAKING LETRA.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Sa dati ring PAGNINIIG.",
                options: ["Lumilipas", "Marangya", "Pagsasarilinan"],
                answer: "Pagsasarilinan"
            },
            {
                question: "Ang sa inyo ay MAGSUKAB.",
                options: ["Magtaksil", "Mapahinto", "Nag-alab"],
                answer: "Magtaksil"
            },
            {
                question: "Nagbigay na sa PUMUKAW.",
                options: ["Gumising", "Magtaksil", "Napasubo"],
                answer: "Gumising"
            },
            {
                question: "Mga mata’y NANLILISIK.",
                options: ["Dinalaw", "Nagagalit", "Gumising"],
                answer: "Nagagalit"
            },
            {
                question: "Tulad nila’y MAMAMANSING.",
                options: ["Mahigpit na pagpulupot", "Makapal na damuhan", "Mamimingwit ng isda"],
                answer: "Mamimingwit ng isda"
            }
        ];
