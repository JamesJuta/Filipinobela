...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 17 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Halos hindi MAGMAKAMAYAN.",
                options: ["Magkaintindihan", "Nainggit", "Tumubo"],
                answer: "Magkaintindihan"
            },
            {
                question: "BUMUKO ang ibang nasa.",
                options: ["Magkaintindihan", "Nainggit", "Tumubo"],
                answer: "Tumubo"
            },
            {
                question: "PANIBUGHO at ang imbot.",
                options: ["Hawak-hawak", "Pagkainggit", "Pinutol"],
                answer: "Pagkainggit"
            },
            {
                question: "Ay pinatid KAPAGKUWAN.",
                options: ["Hawak-hawak", "Pagkainggit", "Pinutol"],
                answer: "Pinutol"
            },
            {
                question: "Pagkahigpit ang SAPUPO.",
                options: ["Hawak-hawak", "Pagkainggit", "Pinutol"],
                answer: "Hawak-hawak"
            }
        ];
