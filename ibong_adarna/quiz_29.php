...
<head>
    ...
    <title>Korido 29 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 29 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "SERAFIN mandiin sa langit.",
                options: ["Alindog", "Anghel", "Utusan"],
                answer: "Anghel"
            },
            {
                question: "SANGHAYA'Y pagkakamalang.",
                options: ["Alindog", "Anghel", "Utusan"],
                answer: "Alindog"
            },
            {
                question: "Ay may anim na LAKAYO.",
                options: ["Alindog", "Anghel", "Utusan"],
                answer: "Utusan"
            },
            {
                question: "Sa gayo’y agad NAG-ATAS.",
                options: ["Humahanay", "Layon", "Nag-utos"],
                answer: "Nag-utos"
            },
            {
                question: "Na ang madla’y LUMALATAG.",
                options: ["Humahanay", "Layon", "Nag-utos"],
                answer: "Humahanay"
            }
        ];
