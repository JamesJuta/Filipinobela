...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 16 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Walang hindi gintong LANTAY.",
                options: ["Bituin", "Buo", "Puro"],
                answer: "Buo"
            },
            {
                question: "O, PANGAHAS, sino ka ba?",
                options: ["Walang bilin", "Walang ingat", "Walang pasabi"],
                answer: "Walang bilin"
            },
            {
                question: "Kung palad kong MASALIWA.",
                options: ["Mabigo", "Namanhid", "Puro"],
                answer: "Mabigo"
            },
            {
                question: "Masawi sa inyong LINGAP.",
                options: ["Mabigo", "Minamaliit", "Pagkalinga"],
                answer: "Pagkalinga"
            },
            {
                question: "O, ako’y SINISIPHAYO.",
                options: ["Mahinhin", "Minamaliit", "Naaninag"],
                answer: "Minamaliit"
            }
        ];
