...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 11 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sugat at lamang NALASOG.",
                options: ["Hiwaga", "Nadurog", "Pagtulong"],
                answer: "Nadurog"
            },
            {
                question: "Naayos ang butong LIINSAD.",
                options: ["Bali", "Nadurog", "Tikas"],
                answer: "Bali"
            },
            {
                question: "Wikang NANANANGIS.",
                options: ["Kabayaran", "Napahamak", "Umiiyak"],
                answer: "Umiiyak"
            },
            {
                question: "Ang buhay kong di NAUTAS.",
                options: ["Kabayaran", "Napahamak", "Umiiyak"],
                answer: "Napahamak"
            },
            {
                question: "Ang damaya’y walang GUGOL.",
                options: ["Napahamak", "Umiiyak", "Kabayaran"],
                answer: "Kabayaran"
            }
        ];
