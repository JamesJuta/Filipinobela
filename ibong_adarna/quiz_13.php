...
<head>
    ...
    <title>Korido 13 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 13 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Mga bungang MAPUPUPOL.",
                options: ["Mapipitas", "Nais", "Pagmamahal"],
                answer: "Mapipitas"
            },
            {
                question: "Sa tuwina’y KAULAYAW.",
                options: ["Bagabag", "Gusto", "Kapiling"],
                answer: "Kapiling"
            },
            {
                question: "Ang anumang iyong NASA.",
                options: ["Kapiling", "Nais", "Pagmamahal"],
                answer: "Nais"
            },
            {
                question: "Ang pag-ibig na DALISAY.",
                options: ["Kapiling", "Nais", "Wagas"],
                answer: "Wagas"
            },
            {
                question: "Kung wala nang SALAGHATI.",
                options: ["Magsama", "Makukuha", "Sama ng Loob"],
                answer: "Sama ng Loob"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_13.php"; // Replace with the actual href link
