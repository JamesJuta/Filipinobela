...
<head>
    ...
    <title>Korido 28 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 28 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sa LAONG di pagkikita.",
                options: ["Masisira", "Nagpuntahan", "Tagal"],
                answer: "Tagal"
            },
            {
                question: "Ang lahat na’y NAGDUMUGANG.",
                options: ["Masisira", "Nagpuntahan", "Tagal"],
                answer: "Nagpuntahan"
            },
            {
                question: "Asahan mong NAWAWAKWAK.",
                options: ["Masisira", "Nagpuntahan", "Tagal"],
                answer: "Masisira"
            },
            {
                question: "Yaring munti kong HINAKDAL.",
                options: ["Hinaing", "Masama", "Tanungin"],
                answer: "Hinaing"
            },
            {
                question: "Anak ko man ay SUWAIL.",
                options: ["Hinaing", "Masama", "Tanungin"],
                answer: "Masama"
            }
        ];
