...
<head>
    ...
    <title>Kabanata 20 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Kabanata 20 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "KASIHAN ka rin ng Langit.",
                options: ["Basbasan", "Daanan", "Umuwi"],
                answer: "Basbasan"
            },
            {
                question: "MUWI na sa kanyang bayan.",
                options: ["Basbasan", "Daanan", "Umuwi"],
                answer: "Umuwi"
            },
            {
                question: "Kabundukan ay TINAHAK.",
                options: ["Dinaanan", "Dumating", "Pagod"],
                answer: "Dinaanan"
            },
            {
                question: "Pagkat labis yaong PAGAL.",
                options: ["Dinaanan", "Dumating", "Pagod"],
                answer: "Pagod"
            },
            {
                question: "Ang Adarna ay DUMATAL.",
                options: ["Dinaanan", "Dumating", "Pagod"],
                answer: "Dumating"
            }
        ];
