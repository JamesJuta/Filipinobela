...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 8 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Yumao",
                options: ["Mabantayan", "Nag-isip", "Namatay"],
                answer: "Namatay"
            },
            {
                question: "Maabagan",
                options: ["Hiniwa", "Masdan", "Napag-isipan"],
                answer: "Masdan"
            },
            {
                question: "Nagnuynoy",
            ...
            {
                question: "Napaghulo",
                options: ["Anyo", "Dumarating", "Hiniwa"],
                answer: "Dumarating"
            },
            {
                question: "Napawi",
                options: ["Dumumi", "Hinawakan", "Nawala"],
                answer: "Nawala"
            }
        ];
