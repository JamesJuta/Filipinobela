...
<head>
    ...
    <title>Korido 5 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 5 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Naparawal",
                options: ["Nabigo", "Napahamak", "Napasama"],
                answer: "Nabigo"
            },
            {
                question: "Kinipkip",
                options: ["Daan", "Dinala", "Mataas"],
                answer: "Dinala"
            },
            {
                question: "Nakadatal",
                options: ["Nakarating", "Nabigo", "Nautal"],
                answer: "Nakarating"
            },
            {
                question: "Namamaang",
                options: ["Landas", "Nagtataka", "Sinalubong"],
                answer: "Nagtataka"
            },
            {
                question: "Masapit",
                options: ["Di Maisip", "Mangyari", "Natatago"],
                answer: "Mangyari"
            }
        ];
