...
<head>
    ...
    <title>Korido 22 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 22 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Siya nama’y KINALINGA.",
                options: ["Hinanakit", "Inalagaan", "Uminom"],
                answer: "Inalagaan"
            },
            {
                question: "Sa bumbong ay TUMUNGGA.",
                options: ["Hinanakit", "Inalagaan", "Uminom"],
                answer: "Uminom"
            },
            {
                question: "Ang HINAMPO kung sa akin.",
                options: ["Hinanakit", "Inalagaan", "Uminom"],
                answer: "Hinanakit"
            },
            {
                question: "Na TARUKIN ang hiwaga.",
                options: ["Batid", "Nahihiya", "Unawain"],
                answer: "Unawain"
            },
            {
                question: "NANGINGIMI ang sarili.",
                options: ["Batid", "Nahihiya", "Unawain"],
                answer: "Nahihiya"
            }        ];
