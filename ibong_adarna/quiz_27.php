...
<head>
    ...
    <title>Korido 27 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 27 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Nagwawari",
                options: ["Napayuko", "Nakikita", "Nag-iisip"],
                answer: "Nag-iisip"
            },
            {
                question: "Namamalas",
                options: ["Mapipili", "Nakikita", "Nag-iisip"],
                answer: "Nakikita"
            },
            {
                question: "Mahihirang",
            ...
            {
                question: "Magbata",
                options: ["Dusa", "Magnilay-nilay", "Magtiis"],
                answer: "Magnilay-nilay"
            },
            {
                question: "Pighati",
                options: ["Dusa", "Magnilay-nilay", "Magtiis"],
