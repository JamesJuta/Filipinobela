...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 2 - Ibong Adarna</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PAGLINANG SA TASALITAAN. TUKUYIN ANG KASING KAHULUGAN.</h2><br>
    ...
    <script>
        const questions = [
            {
                question: "Dukha",
                options: ["Maginhawa ang buhay", "Mahirap ang buhay", "Masinop sa buhay"],
                answer: "Mahirap ang buhay"
            },
            {
                question: "Balakin",
                options: ["Pagsuway", "Pananakot", "Plano"],
                answer: "Plano"
            },
            {
                question: "Uliran",
                options: ["Mabuting halimbawa", "Masamang gawain", "Masamang halimbawa"],
                answer: "Mabuting halimbawa"
            },
            {
                question: "Pagliyag",
                options: ["Pagmamahalan", "Pagpapakasal", "Pagsasakitan"],
                answer: "Pagmamahalan"
            },
            {
                question: "Magigilas",
                options: ["Magaganda", "Mahihina", "Malalakas"],
                answer: "Malalakas"
            }
        ];
