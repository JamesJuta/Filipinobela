...
<head>
    ...
    <title>Korido 23 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 23 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Magbabadya",
                options: ["Hawak", "Magpapatunay", "Napag-isipan"],
                answer: "Magpapatunay"
            },
            {
                question: "Napaghulo",
            ...
            {
                question: "Dinatnan",
                options: ["Hinahanap", "Inabutan", "Nakaalam"],
                answer: "Inabutan"
            },
            {
                question: "Tinutunton",
