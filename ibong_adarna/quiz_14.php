...
<head>
    ...
    <title>Korido 14 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 14 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Sa ibabaw ay BATAKIN.",
                options: ["Binatak", "Hilahin", "Humarang"],
                answer: "Hilahin"
            },
            {
                question: "Nang umaho’y NANANAMLAY",
                options: ["Aalam", "Kalat", "Nanghihina"],
                answer: "Nanghihina"
            },
            {
                question: "Humanda sa MASASAPIT.",
                options: ["Mararating", "Nabagabag", "Ninais"],
                answer: "Mararating"
            },
            {
                question: "Ano’t akin pang NINASA.",
                options: ["Nasabi", "Napalagay", "Ninais"],
                answer: "Ninais"
            },
            {
                question: "Walang damo’t mga SUKAL.",
                options: ["Dulo", "Kalat", "Mababatid"],
                answer: "Kalat"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_14.php"; // Replace with the actual href link
