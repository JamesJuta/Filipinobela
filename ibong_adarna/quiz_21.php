...
<head>
    ...
    <title>Korido 21 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 21 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Tumatangis",
                options: ["Nasasabi", "Umiiyak", "Walang katapusan"],
                answer: "Umiiyak"
            },
            {
                question: "Nasasambit",
            ...
            {
                question: "Walang maliw",
                options: ["Nasasabi", "Umiiyak", "Walang katapusan"],
                answer: "Walang katapusan"
            },
            {
                question: "Liyag",
                options: ["Buhay", "Mahal", "Matapos"],
                answer: "Mahal"
            },
            {
                question: "Mautas",
