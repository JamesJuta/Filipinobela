...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 19 - Ibong Adarna</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Katawan ay LUNONG-LUNO.",
                options: ["Durog", "Hinang-hina", "Nagmumula"],
                answer: "Hinang-hina"
            },
            {
                question: "LASOG pati mga buto.",
                options: ["Durog", "Hinang-hina", "Nagmumula"],
                answer: "Durog"
            },
            {
                question: "Mula rito ay PALINGID.",
                options: ["Kumalong", "Nagmula", "Palihim"],
                answer: "Palihim"
            },
            {
                question: "NABAHAW ang mga sugat.",
                options: ["Gumaling", "Nakaalis", "Tiwasay"],
                answer: "Gumaling"
            },
            {
                question: "Sa balon ay NAKAYAO.",
                options: ["Gumaling", "Nakaalis", "Tiwasay"],
                answer: "Nakaalis"
            }
        ];
