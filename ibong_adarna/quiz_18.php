...
<head>
    ...
    <title>Korido 18 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 18 - Ibong Adarna</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Lobo ay PINAGBILINAN.",
                options: ["Bumagsak", "Inatasan", "Natatangi"],
                answer: "Inatasan"
            },
            {
                question: "MUTYA-MUTYA sa magulang.",
                options: ["Bumagsak", "Inatasan", "Natatangi"],
                answer: "Natatangi"
            },
            {
                question: "Sa ilalim ng LUMAGPAK.",
                options: ["Bumagsak", "Inatasan", "Natatangi"],
                answer: "Bumagsak"
            },
            {
                question: "Madalas na MAGBULAAN.",
                options: ["Kalmado", "Magtataksil", "Magsinungaling"],
                answer: "Magsinungaling"
            },
            {
                question: "May loob na MALUMANAY.",
                options: ["Kalmado", "Magtataksil", "Magsinungaling"],
                answer: "Kalmado"
            }
        ];
