...
<head>
    ...
    <title>Korido 30 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 30 - Ibong Adarna</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Nakatungo",
                options: ["Gumagabay", "Hinaing", "Nakayuko"],
                answer: "Nakayuko"
            },
            {
            ...
            {
                question: "Pahugos",
                options: ["Maligalig", "Matatakot", "Pababa"],
                answer: "Pababa"
            },
            {
                question: "Masisindak",
