...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 27 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Natatap",
                options: ["Nabalitaan", "Nakita", "Nalaman"],
                answer: "Nabalitaan"
            },
            {
                question: "Napahinuhod",
                options: ["Napapayag", "Napilit", "Sumang-ayon"],
                answer: "Sumang-ayon"
            },
            {
                question: "Nabalino",
                options: ["Nahalina", "Nalito", "Nasilaw"],
                answer: "Nalito"
            },
            {
                question: "Naglagalag",
                options: ["Naglayas", "Naglibot", "Nangibang bansa"],
                answer: "Naglibot"
            },
            {
                question: "Makasasayod",
                options: ["Makapaglalarawan", "Makapagsasaad", "Makapagsasabi"],
                answer: "Makapagsasaad"
            }
        ];
