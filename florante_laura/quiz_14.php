...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 14 - Florante at Laura</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PILIIN ANG WASTONG SAGOT SA TAMANG BILANG.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Pagdurusa at kahabagan",
                options: ["Ayaw maging malungkot", "Masungit", "Walang kaginhawahang tatamuhin"],
                answer: "Walang kaginhawahang tatamuhin"
            },
            {
                question: "Lumaki sa tuwa",
                options: [ "Ayaw ng malulungkot ng sandal", "Hindi marunong magtiis", "Nagiging marahas"],
                answer: "Ayaw ng malulungkot ng sandal"
            },
            {
                question: "Magawi sa ligaya’t aliw",
                options: ["Gusto’y laging masaya", "Maghihirap", "Nagiging maramdamin"],
                answer: "Maghihirap"
            },
            {
                question: "Hindi natuturuan ng magulang",
                options: ["Hindi nagiging matalino", "Nagiging mayabang", "Sumasama ang bata"],
                answer: "Sumasama ang bata"
            },
            {
                question: "Ipinadala sa Atenas",
                options: ["Maging mandirigma", "Makita ang kaibigan", "Mamulat ang isipan"],
                answer: "Maging mandirigma"
            }
        ];
