...
<head>
    ...
    <title>Korido 17 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 17 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ito sa buhay ko ang unang umiwas",
                options: ["Ninais pa niyang mamatay", "Pumalit ay kalungkutan", "Unang kalungkutang naramdaman"],
                answer: "Unang kalungkutang naramdaman"
            },
            {
                question: "Baras ng matuwid ay nilapastangan",
                options: ["Hindi iginalang ang katuwiran", "Ninais pa niyang mamatay", "Unang kalungkutang naramdaman"],
                answer: "Hindi iginalang ang katuwiran"
            },
            {
                question: "Nanaw sa akin ang sandaigdigan",
                options: ["Napakasakit tanggapin ang pagkamatay ng kanyang ina", "Pumalit ay kalungkutan", "Unang kalungkutang naramdaman"],
                answer: "Pumalit ay kalungkutan"
            },
            {
                question: "Ng hapdi sa puso di ko maapula",
                options: ["Napakasakit tanggapin ang pagkamatay ng kanyang ina", "Pumalit ay kalungkutan ", "Unang kalungkutan"],
                answer: "Napakasakit tanggapin ang pagkamatay ng kanyang ina"
            },
            {
                question: "Minamasarap kong mutok yaring puso",
                options: ["Hindi iginalang ang katuwiran", "Ninais pa niyang mamatay", "Unang kalungkutang naramdaman"],
                answer: "Ninais pa niyang mamatay"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_17.php"; // Replace with the actual href link
