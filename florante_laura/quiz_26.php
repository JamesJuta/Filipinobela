...
<head>
    ...
    <title>Korido 26 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 26 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang kahulugan ng pinag-isang palad?",
                options: ["Magkapareho ang kapalaran", "Pinag-isang dibdib", "Pinag-uusig ng kapalaran"],
                answer: "Magkapareho ang kapalaran"
            },
            {
                question: "Ilang buwan nanirahan sa gubat ang dalawa?",
                options: ["Apat na buwan", "Anim na buwan", "Limang buwan"],
                answer: "Anim na buwan"
            },
            {
                question: "Aling hirap ang higit na dinanas ni Aladin?",
                options: ["Ang ginawang pagpapahirap ng ama", "Ang maraming giyerang kanyang nasuungan", "Pagtitiis dahil kay Flerida"],
                answer: "Pagtitiis dahil kay Flerida"
            },
            {
                question: "Bakit nahatulang pugutan ng ulo si Aladin?",
                options: ["Dahil iniwan niya ang mga sundalo", "Dahil sa pagkabawi ni Florante sa Reynong Albanya", "Hindi pa siya pinababalik sa Persiya ay umuwi na"],
                answer: "Dahil sa pagkabawi ni Florante sa Reynong Albanya"
            },
            {
                question: "Alin sa mga sumusunod ang naging parusa kay Aladin?",
                options: ["Ginawang alipin", "Pinaalis sa Persiya", "Pinugutan ng ulo"],
                answer: "Pinaalis sa Persiya"
            }
        ];
