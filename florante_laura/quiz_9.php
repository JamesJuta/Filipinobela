...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 9 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Hindi MAPAPAKNIT sa kanyang alaala ang kagandahan ni Laura.",
                options: ["Maalis", "Pabaya", "Pagkagalit"],
                answer: "Maalis"
            },
            {
                question: "Buong akala niya ang kanyang kasintahan ay isang ALIBUGHA.",
                options: ["Maalis", "Magpapasa", "Pabaya"],
                answer: "Pabaya"
            },
            {
                question: "Magdiwang kayot MANULOS ang tuwa.",
                options: ["Maalis", "Magpapasa", "Pabaya"],
                answer: "Magpapasa"
            },
            {
                question: "Nais niyang tapunan ng LINGAP kung ang kanyang buhay ay mahimbing sa wala. ",
                options: ["Matinding simpatiya", "Panandaliang nawalan ng malay", "Tumahimik"],
                answer: "Panandaliang nawalan ng malay"
            },
            {
                question: "Isang buntong-hininga ang PUMULAS sa kanyang dibdib.",
                options: ["Maalis", "Naalis", "Na katingin sa itaas"],
                answer: "Naalis"
            }
        ];
