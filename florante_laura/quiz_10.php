...
<head>
    ...
    <title>Korido 10 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 10 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Bunga ng pinaghirapan ",
                options: ["Nadudurog", "Nagwawagi", "Pagtatagumpay"],
                answer: "Pagtatagumpay"
            },
            {
                question: "Bawat ulos ni Aladin ay bumabaon sa mga leon. Si Aladin ay ______.",
                options: ["Mahusay na mandirigma", "Matapang", "Sanay pumatay"],
                answer: "Mahusay na mandirigma"
            },
            {
                question: "Isang damdaming nararamdaman kapag hindi na makaya ng puso ang tinitiis na hirap.",
                options: ["Nadudurog", "Nagbibigay sa habag ang dibdib", "Nahahabag"],
                answer: "Nagbibigay sa habag ang dibdib"
            },
            {
                question: "Bagamat Moro at kalaban ng Kristiyano, tinulungan pa rin ni Aladin ang binate. Si Aladin ay isang taong ______.",
                options: ["Maginoo", "Mapagkawanggawa", "Mapagkunwari"],
                answer: "Mapagkawanggawa"
            },
            {
                question: "Kinalong inagapayanan hinaplos ang mukhat dibdib gulung-gulo ang loob.",
                options: ["Naaawa", "Nadudurog", "Nagbibigay sa habag ang dibdib"],
                answer: "Nagbibigay sa habag ang dibdib"
            }
        ];
