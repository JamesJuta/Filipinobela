...
<head>
    ...
    <title>Korido 2 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 2 - Florante at Laura</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Mahiganting langit",
                options: ["Diyos", "Katotohanan", "Mga taong nagsasabi ng totoo"],
                answer: "Diyos"
            },
            {
                question: "Sa trono ng puri ay iniluluklok",
                options: ["Kapangyarihan ng masasama ang pinaiiral", "Mga taong mabubuti", "Sa kalagayan o posisyong iginagalang"],
                answer: "Sa kalagayan o posisyong iginagalang"
            },
            {
                question: "Bandila ng lalong kasamaan",
                options: ["Ang nasusunod ay ang masasama", "Kapangyarihan o posisyon ng pagkahari", "Mga taong nagsasabi ng totoo"],
                answer: "Ang nasusunod ay ang masasama"
            },
            {
                question: "Kaliluhay siyang nangyayaring hari",
                options: ["Ang nasusunod ay ang masasama", "Katotohanan", "Sa kalagayan o posisuong iginagalang"],
                answer: "Katotohanan"
            },
            {
                question: "At ang balang bibig na binubukalan",
                options: ["Ang nasusunod ay ang masasama", "Kapangyarihan o posisyon ng pagkakahari", "Mga taong nagsasabi ng totoo"],
                answer: "Mga taong nagsasabi ng totoo"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_2.php"; // Replace with the actual href link
