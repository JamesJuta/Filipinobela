...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 1 - Florante at Laura</u></center></h1>
        </div>

      <h2 class="panuto_form"></i>PANUTO: PILIIN ANG TAMANG PAGLALARAWAN.</h2><br>
    ...
    <script>
        const questions = [
            {
                question: "Naghahandog ng dalamhati at hapis",
                options: [ "Baging", "Bulaklak", "Malaking kahoy"],
                answer: "Malaking kahoy"
            },
            {
                question: "Lilim na nakatatakot, walang bunga, malalapad ang dahon",
                options: ["Gubat", "Higera", "Sipres"],
                answer: "Sipres"
            },
            {
                question: "Punong pinagtalian sa bagong tao",
                options: ["Baging", "Higera", "Malaking kahoy"],
                answer: "Higera"
            },
            {
                question: "Kulay luksa, nakaliliyo ang amoy",
                options: ["Aberno", "Bulaklak", "Sipres"],
                answer: "Bulaklak"
            },
            {
                question: "Dawag na Matinik",
                options: ["Aberno", "Gubat", "Sipres"],
                answer: "Gubat"
            }
        ];
