...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 15 - Florante at Laura</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: TUKUYIN KUNG TAMA O MALI ANG KAISIPANG IPINAPAHAYAG.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Magkaibigan sina Florante at Adolfo.",
                options: ["Mali", "Tama"],
                answer: "Mali"
            },
            {
                question: "Pinadala si Florante sa Atenas upang hindi na mahirapan ang kanyang magualng sa paghubog sa kanyang pagkatao.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Natuwa si Adolfo sa kahusayang ipinamalas ni Florante.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Ang pagtuturo kay Florante ay ipinabahala ng kanyang ama kay Pitaco, isang gusro sa Atenas.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Sa loob ng anim na taon ay naging bihasa siya sa Astrolohiya, Matematika at Pilosopiya.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            }
        ];
