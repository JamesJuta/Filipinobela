...
<body>
    <div id="quiz-container">
        <div id="header">
        <h1><center>Pagsusulit sa Buod - Florante at Laura</u></center></h1>
      </div>
        ...
        const questions = [
            {
                ...
                options: ["Duke Briseo at Prinses Floresca", "Haring Linceo at Reyna Miramolin", "Konde Sileno at Donya Victorina"],
                answer: "Duke Briseo at Prinses Floresca"
            },
            {
                question: "Saan bayan nagmula ang magiting na si Florante",
                options: ["Albanya", "Atenas", "Krotona"],
                answer: "Albanya"
            },
            {
                question: "Sino ang anak ni Konde Sileno na tampulan ng paghanga ng kanyang mga guro?",
                options: ["Adolfo", "Aladin", "Florante"],
                answer: "Adolfo"
            },
            {
                question: "Sino ang nagapi ni Florante sa loob ng limang oras na labanan?",
                options: ["Haring Linceo", "Heneral Osmalik", "Konde Sileno"],
                answer: "Heneral Osmalik"
            },
            {
                question: "Sino ang anak ni Sultan Ali-Adab ng Persiya na mayroong sama ng loob sa ama dahil sa pag-agaw nito kay Flerida?",
                options: ["Adolfo", "Aladin", "Florante"],
                answer: "Aladin"
            },
            {
                question: "Sino ang natagpuan nila Florante at Aladin na nag-uusap sa loob ng gubat?",
                options: ["Flerida at Laura", "Laura at Prinses Floresca", "Berlin"],
                answer: "Flerida at Laura"
            },
            {
                question: "Nang dahil sa kabuktutan ni Adolfo ay pinana siya nito hanggang sa mamatay?",
                options: ["Aladin", "Flerida", "Florante"],
                answer: "Aladin"
            },
            {
                question: "Sino ang tapat na kaibigan at kaagapay ni Florante sa pakikipaglaban?",
                options: ["Antenor", "Menandro", "Miramolin"],
                answer: "Menandro"
            },
            {
                question: "Siya ang Heneral na Turko na lumusob sa Albanya subalit natalo rin.",
                options: ["Antenor", "Menandro", "Miramolin"],
                answer: "Miramolin"
            },
            {
                question: "Siya ang matalinong guro sa Atenas.",
                options: ["Antenor", "Menandro", "Miramolin"],
                answer: "Antenor"
            }
        ];
