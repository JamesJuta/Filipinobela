...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 13 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ang bayang sinilangan ni Florante.",
                options: ["Albanya", "Burol", "Nayadas"],
                answer: "Albanya"
            },
            {
                question: "Nagligtas kay Florante sa Ibong buwitre.",
                options: ["Duke Briseo", "Haring Linceo", "Menalipo"],
                answer: "Menalipo"
            },
            {
                question: "Pribadong tanungan ng Hari.",
                options: ["Duke Briseo", "Haring Liceo", "Prinsesa Floresca"],
                answer: "Duke Briseo"
            },
            {
                question: "Hari ng Albanya.",
                options: ["Haring Liceo", "Prinsesa Floresca", "Sultan Ali-Adab"],
                answer: "Haring Liceo"
            },
            {
                question: "Pangalan ng ina ni Florante.",
                options: ["Flerida", "Laura", "Prinsesa Floresca"],
                answer: "Prinsesa Floresca"
            }
        ];
