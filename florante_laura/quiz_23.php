...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 23 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Naghihingalong sa dugo’y naglutang",
                options: ["Masaya", "Tapusin ang laban", "Walang kalaban-laban"],
                answer: "Walang kalaban-laban"
            },
            {
                question: "Kita ang maglamas",
                options: ["Masaya", "Tapusin ang laban", "Walang kalaban-laban"],
                answer: "Tapusin ang laban"
            },
            {
                question: "Nagluksa ang langit ",
                options: ["Masaya", "Nalungkot", "Patay"],
                answer: "Nalungkot"
            },
            {
                question: "Luha ang nagsabi ng ligayang ganap",
                options: ["Masaya", "Nalungkot", "Walang kalaban-laban"],
                answer: "Masaya"
            },
            {
                question: "Nakipagitan din ang lilong pighati",
                options: ["Masaya", "Pagdaramdam", "Pagkalungkot"],
                answer: "Pagdaramdam"
            }
        ];
