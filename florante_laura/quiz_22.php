...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 22 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ningas ng sintang una kong natikman",
                options: ["Unang pag-ibig", "Unang pagtatapat", "Unang tibok"],
                answer: "Unang pag-ibig"
            },
            {
                question: "Matinding sintang ikinalulunod",
                options: ["Ipinaghihirap", "Ipinagtitiis", "Sinasambit-sambit"],
                answer: "Ipinagtitiis"
            },
            {
                question: "May hiyang perlas na sa mata’y nukal",
                options: ["Dumaloy ang luha", "Nalaglag ang perlas", "Umiyak"],
                answer: "Dumaloy ang luha"
            },
            {
                question: "Sasayod ng bumugsong sakit",
                options: ["Pagdaralita", "Makatitiis ng hirap", "Pagsusumamo"],
                answer: "Pagsusumamo"
            },
            {
                question: "Ang sinisinta’y mawalay sa kasi",
                options: ["Magkahiwalay ang magkasintahan", "Di magkita ang magsing-ibig", "Magkahiwalay ang mag-asawa"],
                answer: "Di magkita ang magsing-ibig"
            }
        ];
