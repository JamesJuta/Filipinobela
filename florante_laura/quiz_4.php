...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 4 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Ano ang kasangkapan gamit ng mandirigma noong unang panahon?",
                options: ["Korales", "Perlas", "Plumahe"],
                answer: "Plumahe"
            },
            {
                question: "Alin ang hindi kagamitan ng mandirigma noong unang panahon?",
                options: ["Turbante", "Plumahe", "Topasyo"],
                answer: "Topasyo"
            },
            {
                question: "Anong uri ng bato na ginagawang kwintas?",
                options: ["Dyamante", "Rubi", "Perlas"],
                answer: "Rubi"
            },
            {
                question: "Anong uri ng bato ang ginagawang singsing?",
                options: ["Dyamante", "Korales", "Topasyo"],
                answer: "Topasyo"
            },
            {
                question: "Alin ang hindi uri ng bato na ginagawang palamuti?",
                options: ["Dyamante", "Korales", "Rubi"],
                answer: "Korales"
            }
        ];
