...
<head>
    ...
    <title>Korido 12 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 12 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Tinunton ang landas na pinagdaanan. ",
                options: ["Ikinagaan ang landas na pinagdaanan.", "Pinuntahan ang landas na pinagdaanan.", "Sinuyo ang landas na pinagdaanan."],
                answer: "Pinuntahan ang landas na pinagdaanan."
            },
            {
                question: "Kusang pinagyaman ang lugaming pangko.",
                options: ["Kusang ikinagaan ang lugaming pangko.", "Kusang pinalago ang lugaming pangko.", "Kusang pinuntahan ang lugaming pangko."],
                answer: "Kusang pinalago ang lugaming pangko."
            },
            {
                question: "Ang nagdaralita’y inamong tumikim.",
                options: ["Ang nagdaralita’y pinuntahan timukim.", "Ang nagdaralita’y ikinagaan tumikim.", "Ang nagdaralita’y sinuyong tumikim."],
                answer: "Ang nagdaralita’y sinuyong tumikim."
            },
            {
                question: "Ikinatiwasay ng may dusang puso.",
                options: ["Ikinagaan ng may dusang puso. ", "Nagkaroon ng kaalaman ng may dusang puso.", "Pinuntahan ng may dusang puso."],
                answer: "Ikinagaan ng may dusang puso. "
            },
            {
                question: "Mula sa hirap mo’y ibig kong matatap. ",
                options: ["Mula sa hirap mo’y ibig kong ikinagaan.", "Mula sa hirap mo’y ibig kong magkaroon ng kaalaman.", "Mula sa hirap mo’y ibig kong sinuyo."],
                answer: "Mula sa hirap mo’y ibig kong magkaroon ng kaalaman."
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_12.php"; // Replace with the actual href link
