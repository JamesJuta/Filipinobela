...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 18 - Florante at Laura</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Malilingat",
                options: ["Kataksilan", "Mag-iingat", "Tumulo"],
                answer: "Mag-iingat"
            },
            {
                question: "Kaliluhan",
                options: ["Kataksilan", "Paghihirap", "Payagan"],
                answer: "Kataksilan"
            },
            {
                question: "Pagdaralita",
                options: ["Paghihirap", "Payagan", "Tumulo"],
                answer: "Paghihirap"
            },
            {
                question: "Bumalisbis",
                options: ["Kataksilan", "Nakisama", "Tumulo"],
                answer: "Tumulo"
            },
            {
                question: "Nakipatnubay",
                options: ["Nakisama","Paghihirap", "Payagan"],
                answer: "Nakisama"
            }
        ];
