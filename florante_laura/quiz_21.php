...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 21 - Florante at Laura</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PILIIN KUNG TAMA O MALI ANG IPINAHAHAYAG.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Itinulad kay Pebo ang Liwanag ng mukha ng dalaga.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Hindi naniniwala si Florante na pinagtaksilan siya ni Laura.",
                options: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Sinisisi ni Florante ang kanyang ama dahil siya ang nagpakilala sa kanya kay Laura.",
                options: ["Mali", "Tama"],
                answer: "Mali"
            },
            {
                question: "Nalipat kay Laura ang pagmamahal na inuukol sa ina nang makilala niya ito.",
                ooptions: ["Mali", "Tama"],
                answer: "Tama"
            },
            {
                question: "Di-gasinong maganda si Laura sapagkat itinulad siya kay Venus.",
                options: ["Mali", "Tama"],
                answer: "Mali"
            }
        ];
