...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 28 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Isang PIPING GULO ang umalingawngaw sa Reynong Albanya.",
                options: ["Hindi gumamit ng baril", "Tahimik na paghihimagsik", "Walang kibuan"],
                answer: "Tahimik na paghihimagsik"
            },
            {
                question: "Ayon sa bulung-bulungan si Haring Linceo and NAGMUNAKALANG gutumin ang reyno.",
                options: ["Nag-akala", "Nagbalas", "Nagpasimuno"],
                answer: "Nagpasimuno"
            },
            {
                question: "Walang MAKAPAGLUMAY sa naguguluhang bayan.",
                options: ["Makapagmungkahi", "Makapagsabi", "Nakapagpahinahon"],
                answer: "Makapagsabi"
            },
            {
                question: "Si Adolfo ay isang PALAMARA.",
                options: ["Mabagsik", "Palaaway", "Taksil"],
                answer: "Taksil"
            },
            {
                question: "Hindi MAWATASAN ang puno’t dulo ng kaguluhan.",
                options: ["Mahirapan", "Maintindihan", "Malaman"],
                answer: "Maintindihan"
            }
        ];
