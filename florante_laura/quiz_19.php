...
<head>
    ...
    <title>Korido 19 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 19 - Florante at Laura</u></center></h1>
        </div>
    ...
    <script>
        const questions = [
            {
                question: "Nagtungo agad sina Florante at Menandros sa _____.",
                options: ["bukid pag-ahon sa dalampasigan", "kinta", "palasyo"],
                answer: "palasyo"
            },
            {
                question: "Ang pariralang bininit ng busog ay _____.",
                options: ["maraming nakain", "pana", "panudla"],
                answer: "maraming nakain"
            },
            {
                question: "Ang dumating samantalang magkayakap ang mag-ama ay ang _____.",
                options: ["embahador ng Atenas", "embahador ng Krotona", "embahador ng Persya",],
                answer: "embahador ng Persya"
            },
            {
                question: "Ang sulat na tinanggap ni Duke Briseo ay buhat sa kanyang _____.",
                options: ["biyenan", "kaibigan", "kapatid"],
                answer: "biyenan"
            },
            {
                question: "Ang ibig sabihin ng kubkob ng kabaka ay _____.",
                options: ["napapaligiran ng mga baka", "napapaligiran ng mga kaaway", "napapaligiran ng mga sundalo"],
                answer: "napapaligiran ng mga sundalo"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_19.php"; // Replace with the actual href link
