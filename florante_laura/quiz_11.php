...
<head>
    ...
    <title>Korido 11 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 11 - Florante at Laura</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: PAGSALIKSIKIN ANG MGA SUMUSUNOD NA RELIHIYON.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Ang ___ ay isang relihiyon na kung saan ang mga tao ay sumasamba sa panginoon. Ito ay ang pinakamaraming sumasamba sa buong mundo.",
                options: ["Iglesia ni Kristo", "Katoliko", "Mormons"],
                answer: "Katoliko"
            },
            {
                question: "Ito ay isa sa mga pangunahing sangay ng Kristiyano ngayon na nagmula sa kilusang kilala bilang Protestanteng Repormasyon.",
                options: ["Aglipayano", "Mormons", "Protestante"],
                answer: "Protestante"
            },
            {
                question: "Ang katawagang ito ay sa taong tumatalima, sumusunod, sumusuko at nagpapasakop sa nag-iisang tunay na Diyos, na si Allah, at tumatakwil sa anumang uri ng pagtatambal sa kanya.",
                options: ["Born Again", "Muslim", "Saksi ni Jehovah"],
                answer: "Muslim"
            },
            {
                question: "Ang relihiyong ito ay itinayo ni Cristo na isang organisasyon, at isang organisadong iglesia, ang tunay na relihiyong pang-cristiyano",
                options: ["Iglesia ni Kristo", "Katoliko", "Mormons"],
                answer: "Iglesia ni Kristo"
            },
            {
                question: "Naniniwala ang mga tao sa isang Diyos na ang pangalan ay Jehovah, ang may likha ng lahat ng bagay at may pangkalahatang Soberanya.",
                options: ["Mormons", "Protestante", "Saksi ni Jehovah"],
                answer: "Saksi ni Jehovah"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_11.php"; // Replace with the actual href link
