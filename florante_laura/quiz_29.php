...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 29 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Tagapagtanggol ng Albanya, Katipan ni Laura.",
                options: ["Aladin", "Florante", "Menandro"],
                answer: "Florante"
            },
            {
                question: "Anak ni Haring Linceo.",
                options: ["Flerida", "Floresca", "Laura"],
                answer: "Laura"
            },
            {
                question: "Sakim na ama ni Aladin.",
                options: ["Adolo", "Duke Briseo", "Sultan Ali-Adab"],
                answer: "Sultan Ali-Adab"
            },
            {
                question: "Prinsipe ng Persiya.",
                options: ["Aladin", "Florante", "Menalipo"],
                answer: "Aladin"
            },
            {
                question: "Tagapagligtas ni Laura.",
