...
<head>
    ...
    <title>Korido 8 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 8 - Florante at Laura</u></center></h1>
        </div>
    
        <h2 class="panuto_form"></i>PANUTO: BIGYAN NG KASINGKAHULUGAN ANG MGA SALITA NA NASA LOOB NG PANGUNGUSAP.</h2><br>
     ...
     <script>
        const questions = [
            {
                question: "Binayaan niyang ang kanyang luhay tumagistis upang maibsan ang hirap na dinadala.",
                options: ["Tumulo", "Malagot", "Mag-aruga"],
                answer: "Tumulo"
            },
            {
                question: "Masarap mag-andukha ang kanyang ama.",
                options: ["Mag-aruga", "Nakatim", "Tumulo"],
                answer: "Mag-aruga"
            },
            {
                question: "Nais na niyang makitil ng kaligayahan dahil maagang namatay ang kanyang ina.",
                options: ["Malagot", "Nagtaksil", "Nakatim"],
                answer: "Malagot"
            },
            {
                question: "Hindi siya nakalasap ng kaligayahan dahil maagang namatay ang kanyang ina.",
                options: ["Mag-aruga", "Nakatim", "Tumulo"],
                answer: "Nakatim"
            },
            {
                question: "Ang akala ng nakagapos ay nagsukab na ang kanyang kasintahan.",
                options: ["Malagot", "Nagtaksil", "Tumulo"],
                answer: "Nagtaksil"
            }
        ];
