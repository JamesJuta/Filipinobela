...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 25 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Balawis",
                options: ["Suwail ", "Taksil", "Tapat"],
                answer: "Suwail "
            },
            {
                question: "Mapighati ",
                options: ["Malungkot", "Mapagtiis", "Masaya"],
                answer: "Malungkot"
            },
            {
                question: "Inpinugal",
                options: ["Iginapos", "Itinali", "Pinawalan"],
                answer: "Iginapos"
            },
            {
                question: "Hangal",
                options: ["Hudas", "Mabait", "Traidor"],
                answer: "Traydor"
            },
            {
                question: "Silu-silo",
                options: ["Kawing-kawing", "Sunud-sunod", "Sampling-simple"],
                answer: "Sunud-sunod"
            }
        ];
