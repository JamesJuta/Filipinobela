...
<head>
    ...
    <title>Korido 7 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 7 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
                        {
                question: "Inabutan ng gererong tumatangis ang nakagapos dahil sa pagkamatay ng _____.",
                options: ["ama", "ina", "kasintahan"],
                answer: "ina"
            },
            {
                question: "Ang naging kaaway at nagpahirap sa ama ng nakagapos ay si _____.",
                options: ["Adolfo", "Haring Linceo", "Konde Sileno"],
                answer: "Haring Linceo"
            },
            {
                question: "Ang parusang iginawad ni Adolfo kay Duke Briseo ay _____.",
                options: ["di-makatao", "di-makatarungan", "walang batayan"],
                answer: "di-makatarungan"
            },
            {
                question: "Ang bangkay ni Duke Briseo ay _____.",
                options: ["inilibing", "ipinaghagisan", "sinunog"],
                answer: "sinunog"
            },
            {
                question: "Ang bayaning Moro ay namangha dahil sa _____.",
                options: ["nagulat sa iyak ng mga hayop", "may nakitang tao", "may narinig na hibik"],
                answer: "nagulat sa iyak ng mga hayop"
            }
        ];
