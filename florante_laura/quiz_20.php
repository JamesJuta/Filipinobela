...
<head>
    ...
    <title>Korido 20 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 20 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "May gayak na digma",
                options: ["Handing makipag-digma", "Magiging tanggulan ng kaharian", "Nag-iisang anak"],
                answer: "Handing makipag-digma"
            },
            {
                question: "Kiyas",
                options: ["Hahagkan ang paa bilang paggalang", "Handing makipag-digma", "Magandang tindig at tipo"],
                answer: "Magandang tindig at tipo"
            },
            {
                question: "Haligi ng setro’t reyno",
                options: ["Handing makipag-digma", "Nag-iisang anak", "Magiging tanggulan ng kaharian"],
                answer: "Magiging tanggulan ng kaharian"
            },
            {
                question: "Bugtong kong anak",
                options: ["Magandang tindig at tipo", "Magiging tanggulan ng kaharian", "Nag-iisang anak"],
                answer: "Nag-iisang anak"
            },
            {
                question: "Nagdapa sa yapak",
                options: ["Hahagkan ang paa bilang paggalang", "Handing makipag-digma", "Magiging tanggulan ng kaharian"],
                answer: "Hahagkan ang paa bilang paggalang"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_20.php"; // Replace with the actual href link
