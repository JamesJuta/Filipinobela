...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 6 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Pika",
                options: ["Nagpahinga", "Napagod", "Sibat"],
                answer: "Sibat"
            },
            {
                question: "Persiya",
                options: ["Kahariang nasa ilalim ng mga Muslim", "Mga Diyos ng pagbabaka", "Tulad ng kapalarang sinapit ni Aladin"],
                answer: "Kahariang nasa ilalim ng mga Muslim"
            },
            {
                question: "Nagdamdam-ngawit",
                options: ["Diyos ng pagbabaka", "Diyosa ng kapalaran", "Diyosa ng pag-ibig"],
                answer: "Diyosa ng pag-ibig"
            },
            {
                question: "Puryas",
                options: ["Diyos ng pagbabaka", "Diyosa ng kapalaran", "Diyosa ng pag-ibig"],
                answer: "Diyosa ng kapalaran"
            },
            {
                question: "Marte",
                options: ["Diyos ng pagbabaka", "Diyosa ng kapalaran", "Diyosa ng pag-ibig"],
                answer: "Diyos ng pagbabaka"
            }
        ];
