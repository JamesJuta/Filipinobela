...
<head>
    ...
    <title>Korido 3 - Pagsusulit</title>
...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 3 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Apuhapin, Hanapin, Hagilapin",
                options: ["Hagilapin, Apuhapin, Hanapin", "Hanapin, Hagilapin, Apuhapin"],
                answer: "Hanapin, Hagilapin, Apuhapin"
            },
            {
                question: "Matarok, Makauunawa, Maiintindihan, Matatalos, Mababatid",
                options: ["Maiintindihan, Makauunawa, Mababatid, Matatarok, Matatalos", "Makauunawa, Mababatid, Matatalos, Matatarok, Maiintindihan"],
                answer: "Maiintindihan, Makauunawa, Mababatid, Matatarok, Matatalos"
            },
            {
                question: "Pagbabata, Pagtitiis, Paghihinagpis, Pagdurusa",
                options: ["Paghihinagpis, Pagdurusa, Pagtitiis, Pagbabata", "Pagtitiis, Paghihinagpis, Pagdurusa, Pagbabata"],
                answer: "Pagtitiis, Paghihinagpis, Pagdurusa, Pagbabata"
            },
            {
                question: "Gunamgunam, Iniisip-isip, Ginugunita, Giniguniguni, Pinapangarap",
                options: ["Iniisip-isip, Ginuguni-guni, Gunamgunam, Pinapangarap, Ginugunita", "Pinapangarap, Gunamgunam, Ginuguni-guni, Iniisip-isip, Ginugunita"],
                answer: "Iniisip-isip, Ginuguni-guni, Gunamgunam, Pinapangarap, Ginugunita"
            },
            {
                question: "Ipinaghirap, Ipinagtitiis, Ipinagpapakasakit ",
                options: ["Ipinaghihirap, Ipinagpapakasakit, Ipinagtitiis", "Ipinagtitiis, Ipinaghihirap, Ipinagpapakasakit"],
                answer: "Ipinagtitiis, Ipinaghihirap, Ipinagpapakasakit"
            }
        ];
        ...
        function showResult() {
            ...
            restartButton.href = "quiz_3.php"; // Replace with the actual href link
