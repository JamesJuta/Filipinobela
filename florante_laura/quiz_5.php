...
<body>
    <div id="quiz-container">
        <div id="header">
            <h1><center>Pagsusulit sa Korido 5 - Florante at Laura</u></center></h1>
        </div>
     ...
     <script>
        const questions = [
            {
                question: "Napayukayok",
                options: ["Naidlip", "Nakatulog", "Napayuko"],
                answer: "Napayuko"
            },
            {
                question: "Siniphayo",
                options: ["Pinagdusahan", "Pinagtaksilan", "Pinasikatan"],
                answer: "Pinagdusahan"
            },
            {
                question: "Nakaapula",
                options: ["Pamunas", "Pang-alis", "Panlunas"],
                answer: "Panlunas"
            },
            {
                question: "Dapyuhan",
                options: ["Damayan", "Dampian", "Dapuan"],
                answer: "Damayan"
            },
            {
                question: "Ipinagkanulo",
                options: ["Ipinagpalit", "Pinagtaksilan", "Pinagtapatan"],
